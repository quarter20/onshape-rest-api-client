...
T = TypeVar("T", bound="BTMParameterNotice4455")


@_attrs_define
class BTMParameterNotice4455:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_notice_4455.additional_properties = d
        return btm_parameter_notice_4455
