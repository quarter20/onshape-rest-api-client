...
from ..models.gbt_assembly_simulation_type import GBTAssemblySimulationType
...
T = TypeVar("T", bound="BTAssemblySimulation2246")
...
class BTAssemblySimulation2246:
    ...
    Attributes:
        ...
        type_ (GBTAssemblySimulationType | Unset):
    ...
    type_: GBTAssemblySimulationType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = GBTAssemblySimulationType(_type_)
        ...
        bt_assembly_simulation_2246.additional_properties = d
        return bt_assembly_simulation_2246
