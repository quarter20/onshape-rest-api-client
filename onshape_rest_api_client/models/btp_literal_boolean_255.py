...
T = TypeVar("T", bound="BTPLiteralBoolean255")


@_attrs_define
class BTPLiteralBoolean255:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_literal_boolean_255.additional_properties = d
        return btp_literal_boolean_255
