...
T = TypeVar("T", bound="BTFeatureApiBase1430")


@_attrs_define
class BTFeatureApiBase1430:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_feature_api_base_1430.additional_properties = d
        return bt_feature_api_base_1430
