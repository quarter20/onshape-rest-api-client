...
T = TypeVar("T", bound="BTListResponseBTWebhookInfo")
...
class BTListResponseBTWebhookInfo:
    ...
    Attributes:
        ...
        items (list[BTWebhookInfo] | Unset): Array of items in the current page.
    ...
    items: list[BTWebhookInfo] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = BTWebhookInfo.from_dict(items_item_data)
        ...
        bt_list_response_bt_webhook_info = cls(
            href=href,
            items=items,
            next_=next_,
            previous=previous,
        ...
        bt_list_response_bt_webhook_info.additional_properties = d
        return bt_list_response_bt_webhook_info
