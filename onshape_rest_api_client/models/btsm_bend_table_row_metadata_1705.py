...
T = TypeVar("T", bound="BTSMBendTableRowMetadata1705")


@_attrs_define
class BTSMBendTableRowMetadata1705:
    """
    Attributes:
        ...
        is_joint_type_editable (bool | Unset):
    """
    ...
    is_joint_type_editable: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_joint_type_editable = self.is_joint_type_editable
        ...
        if is_joint_type_editable is not UNSET:
            field_dict["isJointTypeEditable"] = is_joint_type_editable
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_joint_type_editable = d.pop("isJointTypeEditable", UNSET)

        btsm_bend_table_row_metadata_1705 = cls(
            bt_type=bt_type,
            cross_highlight_data_if_any=cross_highlight_data_if_any,
            cross_highlight_data=cross_highlight_data,
            is_joint_type_editable=is_joint_type_editable,
        )

        btsm_bend_table_row_metadata_1705.additional_properties = d
        return btsm_bend_table_row_metadata_1705
