...
T = TypeVar("T", bound="BTPublicationBulkItemParams")


@_attrs_define
class BTPublicationBulkItemParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_publication_bulk_item_params = cls(
            items=items,
        )

        bt_publication_bulk_item_params.additional_properties = d
        return bt_publication_bulk_item_params
