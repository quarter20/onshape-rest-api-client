...
T = TypeVar("T", bound="BTMSketchGeomEntity5")


@_attrs_define
class BTMSketchGeomEntity5:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_sketch_geom_entity_5.additional_properties = d
        return btm_sketch_geom_entity_5
