...
T = TypeVar("T", bound="BTParameterSpecReferenceWithConfiguration2950")


@_attrs_define
class BTParameterSpecReferenceWithConfiguration2950:
    """
    Attributes:
    ...
    allow_assemblies: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        allow_assemblies = self.allow_assemblies
        ...
        if allow_assemblies is not UNSET:
            field_dict["allowAssemblies"] = allow_assemblies
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allow_assemblies = d.pop("allowAssemblies", UNSET)
        ...
        bt_parameter_spec_reference_with_configuration_2950 = cls(
            ...
            allow_assemblies=allow_assemblies,
            allowed_insertable_types=allowed_insertable_types,
            max_number_of_picks=max_number_of_picks,
        )

        bt_parameter_spec_reference_with_configuration_2950.additional_properties = d
        return bt_parameter_spec_reference_with_configuration_2950
