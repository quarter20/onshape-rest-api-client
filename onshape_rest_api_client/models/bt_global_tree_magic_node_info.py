...
T = TypeVar("T", bound="BTGlobalTreeMagicNodeInfo")
...
class BTGlobalTreeMagicNodeInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_global_tree_magic_node_info = cls(
            json_type=json_type,
            can_move=can_move,
        ...
        bt_global_tree_magic_node_info.additional_properties = d
        return bt_global_tree_magic_node_info
