...
from ...models.get_part_studio_edges_wvm import GetPartStudioEdgesWvm
from ...types import UNSET, Response, Unset


def _get_kwargs(
    did: str,
    wvm: GetPartStudioEdgesWvm,
    wvmid: str,
    eid: str,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/tessellatededges".format(
