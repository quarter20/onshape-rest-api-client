...
T = TypeVar("T", bound="BTAssemblySimulationStructuralLoadsTable3867")


@_attrs_define
class BTAssemblySimulationStructuralLoadsTable3867:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_assembly_simulation_structural_loads_table_3867 = cls(
        ...
        bt_assembly_simulation_structural_loads_table_3867.additional_properties = d
        return bt_assembly_simulation_structural_loads_table_3867
