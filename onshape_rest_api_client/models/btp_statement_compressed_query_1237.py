...
T = TypeVar("T", bound="BTPStatementCompressedQuery1237")


@_attrs_define
class BTPStatementCompressedQuery1237:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_statement_compressed_query_1237 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_statement_compressed_query_1237.additional_properties = d
        return btp_statement_compressed_query_1237
