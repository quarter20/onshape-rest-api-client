...
T = TypeVar("T", bound="BTConfiguredFeatureColumnInfo1014")


@_attrs_define
class BTConfiguredFeatureColumnInfo1014:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_configured_feature_column_info_1014 = cls(
            bt_type=bt_type,
            id=id,
            node_id=node_id,
        ...
        bt_configured_feature_column_info_1014.additional_properties = d
        return bt_configured_feature_column_info_1014
