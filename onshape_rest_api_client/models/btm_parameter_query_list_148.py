...
T = TypeVar("T", bound="BTMParameterQueryList148")


@_attrs_define
class BTMParameterQueryList148:
    """
    Attributes:
        ...
        queries (list[BTMIndividualQueryBase139] | Unset):
    """
    ...
    queries: list[BTMIndividualQueryBase139] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _queries is not UNSET:
            ...
            for queries_item_data in _queries:
                queries_item = BTMIndividualQueryBase139.from_dict(queries_item_data)

                queries.append(queries_item)

        btm_parameter_query_list_148 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_query_list_148.additional_properties = d
        return btm_parameter_query_list_148
