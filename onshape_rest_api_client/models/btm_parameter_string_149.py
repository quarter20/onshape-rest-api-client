...
T = TypeVar("T", bound="BTMParameterString149")


@_attrs_define
class BTMParameterString149:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_string_149.additional_properties = d
        return btm_parameter_string_149
