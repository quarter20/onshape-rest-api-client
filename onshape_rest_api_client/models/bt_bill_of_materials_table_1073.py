...
T = TypeVar("T", bound="BTBillOfMaterialsTable1073")


@_attrs_define
class BTBillOfMaterialsTable1073:
    """
    Attributes:
        ...
        title (str | Unset):
        failed_metadata_representative_occurrences (list[str] | Unset):
        indented (bool | Unset):
        is_protected_workspace (bool | Unset):
        is_showing_top_level_assembly_row (bool | Unset):
        part_number (str | Unset):
        revision (str | Unset):
        showing_excluded (bool | Unset):
    ...
    failed_metadata_representative_occurrences: list[str] | Unset = UNSET
    indented: bool | Unset = UNSET
    is_protected_workspace: bool | Unset = UNSET
    is_showing_top_level_assembly_row: bool | Unset = UNSET
    part_number: str | Unset = UNSET
    revision: str | Unset = UNSET
    showing_excluded: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        failed_metadata_representative_occurrences: list[str] | Unset = UNSET
        if not isinstance(self.failed_metadata_representative_occurrences, Unset):
            failed_metadata_representative_occurrences = self.failed_metadata_representative_occurrences

        indented = self.indented

        is_protected_workspace = self.is_protected_workspace
        ...
        showing_excluded = self.showing_excluded
        ...
        if failed_metadata_representative_occurrences is not UNSET:
            field_dict["failedMetadataRepresentativeOccurrences"] = failed_metadata_representative_occurrences
        if indented is not UNSET:
            field_dict["indented"] = indented
        if is_protected_workspace is not UNSET:
            field_dict["isProtectedWorkspace"] = is_protected_workspace
        ...
        if showing_excluded is not UNSET:
            field_dict["showingExcluded"] = showing_excluded
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        failed_metadata_representative_occurrences = cast(
            list[str], d.pop("failedMetadataRepresentativeOccurrences", UNSET)
        )

        indented = d.pop("indented", UNSET)

        is_protected_workspace = d.pop("isProtectedWorkspace", UNSET)
        ...
        showing_excluded = d.pop("showingExcluded", UNSET)

        subassembly_bom_behavior_name = d.pop("subassemblyBomBehaviorName", UNSET)

        bt_bill_of_materials_table_1073 = cls(
            ...
            title=title,
            failed_metadata_representative_occurrences=failed_metadata_representative_occurrences,
            indented=indented,
            is_protected_workspace=is_protected_workspace,
            is_showing_top_level_assembly_row=is_showing_top_level_assembly_row,
            part_number=part_number,
            revision=revision,
            showing_excluded=showing_excluded,
            subassembly_bom_behavior_name=subassembly_bom_behavior_name,
        )

        bt_bill_of_materials_table_1073.additional_properties = d
        return bt_bill_of_materials_table_1073
