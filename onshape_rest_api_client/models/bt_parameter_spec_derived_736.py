...
T = TypeVar("T", bound="BTParameterSpecDerived736")


@_attrs_define
class BTParameterSpecDerived736:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_derived_736 = cls(
        ...
        bt_parameter_spec_derived_736.additional_properties = d
        return bt_parameter_spec_derived_736
