...
T = TypeVar("T", bound="BTMParameterReferenceTable917")


@_attrs_define
class BTMParameterReferenceTable917:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_reference_table_917 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_reference_table_917.additional_properties = d
        return btm_parameter_reference_table_917
