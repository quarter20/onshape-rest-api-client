...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> BTFeatureApiBase1430:
    response_default = BTFeatureApiBase1430.from_dict(response.json())
