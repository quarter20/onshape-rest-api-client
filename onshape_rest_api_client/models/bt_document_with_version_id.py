...
T = TypeVar("T", bound="BTDocumentWithVersionId")
...
class BTDocumentWithVersionId:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_document_with_version_id = cls(
            document_id=document_id,
            document_version_id=document_version_id,
        )

        bt_document_with_version_id.additional_properties = d
        return bt_document_with_version_id
