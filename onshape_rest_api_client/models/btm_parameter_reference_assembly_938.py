...
T = TypeVar("T", bound="BTMParameterReferenceAssembly938")


@_attrs_define
class BTMParameterReferenceAssembly938:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_reference_assembly_938 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_reference_assembly_938.additional_properties = d
        return btm_parameter_reference_assembly_938
