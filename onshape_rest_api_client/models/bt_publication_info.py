...
if TYPE_CHECKING:
    ...
    from ..models.bt_publication_info_item import BTPublicationInfoItem
    from ..models.bt_user_basic_summary_info import BTUserBasicSummaryInfo


T = TypeVar("T", bound="BTPublicationInfo")


@_attrs_define
class BTPublicationInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
        ...
        default_workspace_id (str | Unset):
        items (list[BTPublicationInfoItem] | Unset):
        notes (str | Unset):
        sequence (str | Unset):
    """
    ...
    default_workspace_id: str | Unset = UNSET
    items: list[BTPublicationInfoItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = BTPublicationInfoItem.from_dict(items_item_data)
        ...
        bt_publication_info.additional_properties = d
        return bt_publication_info
