...
T = TypeVar("T", bound="BTPLiteralString259")


@_attrs_define
class BTPLiteralString259:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_literal_string_259.additional_properties = d
        return btp_literal_string_259
