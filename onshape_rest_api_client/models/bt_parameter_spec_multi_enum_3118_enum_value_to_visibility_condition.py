...
T = TypeVar("T", bound="BTParameterSpecMultiEnum3118EnumValueToVisibilityCondition")


@_attrs_define
class BTParameterSpecMultiEnum3118EnumValueToVisibilityCondition:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        bt_parameter_spec_multi_enum_3118_enum_value_to_visibility_condition = cls()
        ...
        bt_parameter_spec_multi_enum_3118_enum_value_to_visibility_condition.additional_properties = (
            additional_properties
        )
        return bt_parameter_spec_multi_enum_3118_enum_value_to_visibility_condition
