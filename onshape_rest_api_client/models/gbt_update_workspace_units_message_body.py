...
T = TypeVar("T", bound="GBTUpdateWorkspaceUnitsMessageBody")


@_attrs_define
class GBTUpdateWorkspaceUnitsMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_update_workspace_units_message_body = cls(
        ...
        gbt_update_workspace_units_message_body.additional_properties = d
        return gbt_update_workspace_units_message_body
