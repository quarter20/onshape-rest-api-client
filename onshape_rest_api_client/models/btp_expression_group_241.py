...
T = TypeVar("T", bound="BTPExpressionGroup241")


@_attrs_define
class BTPExpressionGroup241:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    content: BTPExpression9 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_content, Unset):
            ...
            content = BTPExpression9.from_dict(_content)

        btp_expression_group_241 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_expression_group_241.additional_properties = d
        return btp_expression_group_241
