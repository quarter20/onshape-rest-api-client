...
if TYPE_CHECKING:
    ...
    from ..models.btm_parametric_part_studio_feature_3883 import BTMParametricPartStudioFeature3883
    from ..models.btm_suppression_state_1924 import BTMSuppressionState1924


T = TypeVar("T", bound="BTParametricPartStudioInstance4374")


@_attrs_define
class BTParametricPartStudioInstance4374:
    """
    Attributes:
        ...
        locked_state (bool | Unset):
        microversion_id (BTMicroversionId366 | Unset):
        node_with_reference_list (list[BTNodeWithReference] | Unset):
        parametric_part_studio_feature (BTMParametricPartStudioFeature3883 | Unset):
        reference_parameter (BTMParameterReferencePartStudio3302 | Unset):
    ...
    locked_state: bool | Unset = UNSET
    microversion_id: BTMicroversionId366 | Unset = UNSET
    node_with_reference_list: list[BTNodeWithReference] | Unset = UNSET
    parametric_part_studio_feature: BTMParametricPartStudioFeature3883 | Unset = UNSET
    reference_parameter: BTMParameterReferencePartStudio3302 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        parametric_part_studio_feature: dict[str, Any] | Unset = UNSET
        if not isinstance(self.parametric_part_studio_feature, Unset):
            parametric_part_studio_feature = self.parametric_part_studio_feature.to_dict()
        ...
        if parametric_part_studio_feature is not UNSET:
            field_dict["parametricPartStudioFeature"] = parametric_part_studio_feature
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        locked_state = d.pop("lockedState", UNSET)
        ...
        _parametric_part_studio_feature = d.pop("parametricPartStudioFeature", UNSET)
        parametric_part_studio_feature: BTMParametricPartStudioFeature3883 | Unset
        if isinstance(_parametric_part_studio_feature, Unset):
            parametric_part_studio_feature = UNSET
        else:
            parametric_part_studio_feature = BTMParametricPartStudioFeature3883.from_dict(
                _parametric_part_studio_feature
            )
        ...
        if isinstance(_reference_parameter, Unset):
            ...
            reference_parameter = BTMParameterReferencePartStudio3302.from_dict(_reference_parameter)

        version_id = d.pop("versionId", UNSET)

        version_id_if_external = d.pop("versionIdIfExternal", UNSET)

        bt_parametric_part_studio_instance_4374 = cls(
            bt_type=bt_type,
            ...
            parametric_part_studio_feature=parametric_part_studio_feature,
            reference_parameter=reference_parameter,
            version_id=version_id,
            version_id_if_external=version_id_if_external,
        )

        bt_parametric_part_studio_instance_4374.additional_properties = d
        return bt_parametric_part_studio_instance_4374
