...
def sync_detailed(
    ...
    *,
    ...
    """Update the definition of a Part Studio feature.
     ...
     Replaces an existing feature in the location of the existing feature. See the [Features API
    Guide](https://onshape-public.github.io/docs/api-adv/featureaccess/) for additional information.
