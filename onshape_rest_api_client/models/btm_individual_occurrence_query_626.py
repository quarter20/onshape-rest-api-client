...
T = TypeVar("T", bound="BTMIndividualOccurrenceQuery626")


@_attrs_define
class BTMIndividualOccurrenceQuery626:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_individual_occurrence_query_626 = cls(
            bt_type=bt_type,
        ...
        btm_individual_occurrence_query_626.additional_properties = d
        return btm_individual_occurrence_query_626
