...
from ...models.next_numbers_response_default import NextNumbersResponseDefault
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> NextNumbersResponseDefault:
    response_default = NextNumbersResponseDefault.from_dict(response.json())
