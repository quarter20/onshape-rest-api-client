...
if TYPE_CHECKING:
    from ..models.bt_inner_parameter_location_1715 import BTInnerParameterLocation1715
    from ..models.bt_table_column_spec_1967 import BTTableColumnSpec1967


T = TypeVar("T", bound="BTConfiguredParameterColumnInfo2900")


@_attrs_define
class BTConfiguredParameterColumnInfo2900:
    """
    Attributes:
        ...
        inner_parameter_location (BTInnerParameterLocation1715 | Unset):
    ...
    inner_parameter_location: BTInnerParameterLocation1715 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        inner_parameter_location: dict[str, Any] | Unset = UNSET
        if not isinstance(self.inner_parameter_location, Unset):
            inner_parameter_location = self.inner_parameter_location.to_dict()
        ...
        if inner_parameter_location is not UNSET:
            field_dict["innerParameterLocation"] = inner_parameter_location
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _inner_parameter_location = d.pop("innerParameterLocation", UNSET)
        inner_parameter_location: BTInnerParameterLocation1715 | Unset
        if isinstance(_inner_parameter_location, Unset):
            inner_parameter_location = UNSET
        else:
            inner_parameter_location = BTInnerParameterLocation1715.from_dict(_inner_parameter_location)

        parameter_id = d.pop("parameterId", UNSET)

        bt_configured_parameter_column_info_2900 = cls(
            bt_type=bt_type,
            id=id,
            node_id=node_id,
            ...
            inner_parameter_location=inner_parameter_location,
            parameter_id=parameter_id,
        )

        bt_configured_parameter_column_info_2900.additional_properties = d
        return bt_configured_parameter_column_info_2900
