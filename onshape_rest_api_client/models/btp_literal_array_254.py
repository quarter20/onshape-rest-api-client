...
T = TypeVar("T", bound="BTPLiteralArray254")


@_attrs_define
class BTPLiteralArray254:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_literal_array_254.additional_properties = d
        return btp_literal_array_254
