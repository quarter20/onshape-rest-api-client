...
T = TypeVar("T", bound="EncodingHeaders")


@_attrs_define
class EncodingHeaders:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encoding_headers.additional_properties = additional_properties
        return encoding_headers
