...
if TYPE_CHECKING:
    ...
    from ..models.bt_part_studio_display_data_reference_4360_tessellation_settings import (
        BTPartStudioDisplayDataReference4360TessellationSettings,
    )


T = TypeVar("T", bound="BTPartStudioDisplayDataReference4360")


@_attrs_define
class BTPartStudioDisplayDataReference4360:
    """
    Attributes:
        ...
        cache_data_path (BTCacheDataPath191 | Unset):
        tessellation_settings (BTPartStudioDisplayDataReference4360TessellationSettings | Unset):
    """
    ...
    cache_data_path: BTCacheDataPath191 | Unset = UNSET
    tessellation_settings: BTPartStudioDisplayDataReference4360TessellationSettings | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cache_data_path: dict[str, Any] | Unset = UNSET
        if not isinstance(self.cache_data_path, Unset):
            cache_data_path = self.cache_data_path.to_dict()

        tessellation_settings: dict[str, Any] | Unset = UNSET
        if not isinstance(self.tessellation_settings, Unset):
            tessellation_settings = self.tessellation_settings.to_dict()
        ...
        if cache_data_path is not UNSET:
            field_dict["cacheDataPath"] = cache_data_path
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _cache_data_path = d.pop("cacheDataPath", UNSET)
        cache_data_path: BTCacheDataPath191 | Unset
        if isinstance(_cache_data_path, Unset):
            cache_data_path = UNSET
        else:
            cache_data_path = BTCacheDataPath191.from_dict(_cache_data_path)

        _tessellation_settings = d.pop("tessellationSettings", UNSET)
        tessellation_settings: BTPartStudioDisplayDataReference4360TessellationSettings | Unset
        if isinstance(_tessellation_settings, Unset):
            tessellation_settings = UNSET
        else:
            tessellation_settings = BTPartStudioDisplayDataReference4360TessellationSettings.from_dict(
                _tessellation_settings
            )
        ...
        bt_part_studio_display_data_reference_4360.additional_properties = d
        return bt_part_studio_display_data_reference_4360
