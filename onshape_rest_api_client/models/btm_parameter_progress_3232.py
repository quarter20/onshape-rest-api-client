...
from ..models.gbt_compute_status import GBTComputeStatus
from ..models.gbt_parameter_library_relation_type import GBTParameterLibraryRelationType
from ..types import UNSET, Unset

T = TypeVar("T", bound="BTMParameterProgress3232")


@_attrs_define
class BTMParameterProgress3232:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if percent_done is not UNSET:
            field_dict["percentDone"] = percent_done
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        percent_done = d.pop("percentDone", UNSET)
        ...
        if isinstance(_status, Unset):
            ...
            status = GBTComputeStatus(_status)
        ...
        return btm_parameter_progress_3232
