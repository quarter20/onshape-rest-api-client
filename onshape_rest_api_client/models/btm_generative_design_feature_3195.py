...
T = TypeVar("T", bound="BTMGenerativeDesignFeature3195")


@_attrs_define
class BTMGenerativeDesignFeature3195:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_generative_design_feature_3195 = cls(
            bt_type=bt_type,
        ...
        btm_generative_design_feature_3195.additional_properties = d
        return btm_generative_design_feature_3195
