...
T = TypeVar("T", bound="BTFeatureEntity34")


@_attrs_define
class BTFeatureEntity34:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_feature_entity_34.additional_properties = d
        return bt_feature_entity_34
