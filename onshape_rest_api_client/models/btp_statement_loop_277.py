...
T = TypeVar("T", bound="BTPStatementLoop277")


@_attrs_define
class BTPStatementLoop277:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_statement_loop_277.additional_properties = d
        return btp_statement_loop_277
