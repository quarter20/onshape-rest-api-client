...
T = TypeVar("T", bound="BTMParameterBlobReference1679")


@_attrs_define
class BTMParameterBlobReference1679:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        blob_import: dict[str, Any] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _blob_import = d.pop("blobImport", UNSET)
        blob_import: BTMImport136 | Unset
        if isinstance(_blob_import, Unset):
            blob_import = UNSET
        else:
        ...
        btm_parameter_blob_reference_1679.additional_properties = d
        return btm_parameter_blob_reference_1679
