...
T = TypeVar("T", bound="BTPStatementReturn281")


@_attrs_define
class BTPStatementReturn281:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        space_after_return (BTPSpace10 | Unset):
    ...
    space_after_return: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_return: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_return, Unset):
            space_after_return = self.space_after_return.to_dict()
        ...
        if space_after_return is not UNSET:
            field_dict["spaceAfterReturn"] = space_after_return
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _space_after_return = d.pop("spaceAfterReturn", UNSET)
        space_after_return: BTPSpace10 | Unset
        if isinstance(_space_after_return, Unset):
            space_after_return = UNSET
        else:
            space_after_return = BTPSpace10.from_dict(_space_after_return)
        ...
        btp_statement_return_281 = cls(
            ...
            space_after_return=space_after_return,
            value=value,
        )

        btp_statement_return_281.additional_properties = d
        return btp_statement_return_281
