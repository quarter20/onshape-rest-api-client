...
if TYPE_CHECKING:
    from ..models.btm_parameter_lookup_table_path_1419_value import BTMParameterLookupTablePath1419Value


T = TypeVar("T", bound="BTMParameterLookupTablePath1419")


@_attrs_define
class BTMParameterLookupTablePath1419:
    """
    Attributes:
        ...
        value (BTMParameterLookupTablePath1419Value | Unset):
    """
    ...
    value: BTMParameterLookupTablePath1419Value | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_value, Unset):
            ...
            value = BTMParameterLookupTablePath1419Value.from_dict(_value)

        btm_parameter_lookup_table_path_1419 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_lookup_table_path_1419.additional_properties = d
        return btm_parameter_lookup_table_path_1419
