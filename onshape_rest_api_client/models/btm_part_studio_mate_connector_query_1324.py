...
T = TypeVar("T", bound="BTMPartStudioMateConnectorQuery1324")


@_attrs_define
class BTMPartStudioMateConnectorQuery1324:
    """
    Attributes:
        ...
        feature_id_with_occurrence (str | Unset):
        part_studio_mate_connector_query (bool | Unset):
        query_data (str | Unset):
    """
    ...
    feature_id_with_occurrence: str | Unset = UNSET
    part_studio_mate_connector_query: bool | Unset = UNSET
    query_data: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        feature_id_with_occurrence = self.feature_id_with_occurrence

        part_studio_mate_connector_query = self.part_studio_mate_connector_query
        ...
        if feature_id_with_occurrence is not UNSET:
            field_dict["featureIdWithOccurrence"] = feature_id_with_occurrence
        if part_studio_mate_connector_query is not UNSET:
            field_dict["partStudioMateConnectorQuery"] = part_studio_mate_connector_query
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feature_id_with_occurrence = d.pop("featureIdWithOccurrence", UNSET)

        part_studio_mate_connector_query = d.pop("partStudioMateConnectorQuery", UNSET)

        query_data = d.pop("queryData", UNSET)

        btm_part_studio_mate_connector_query_1324 = cls(
            bt_type=bt_type,
            ...
            feature_id_with_occurrence=feature_id_with_occurrence,
            part_studio_mate_connector_query=part_studio_mate_connector_query,
            query_data=query_data,
        )

        btm_part_studio_mate_connector_query_1324.additional_properties = d
        return btm_part_studio_mate_connector_query_1324
