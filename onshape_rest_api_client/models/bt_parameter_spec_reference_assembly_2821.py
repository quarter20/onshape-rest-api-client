...
T = TypeVar("T", bound="BTParameterSpecReferenceAssembly2821")


@_attrs_define
class BTParameterSpecReferenceAssembly2821:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_assembly_2821 = cls(
        ...
        bt_parameter_spec_reference_assembly_2821.additional_properties = d
        return bt_parameter_spec_reference_assembly_2821
