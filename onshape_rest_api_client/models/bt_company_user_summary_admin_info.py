...
T = TypeVar("T", bound="BTCompanyUserSummaryAdminInfo")


@_attrs_define
class BTCompanyUserSummaryAdminInfo:
    """
    Attributes:
        json_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_company_user_summary_admin_info.additional_properties = d
        return bt_company_user_summary_admin_info
