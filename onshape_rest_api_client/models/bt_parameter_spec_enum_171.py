...
if TYPE_CHECKING:
    from ..models.bt_enum_option_visibility_condition_list_2936 import BTEnumOptionVisibilityConditionList2936
    from ..models.bt_parameter_spec_enum_171_enum_value_to_visibility_condition import (
...
T = TypeVar("T", bound="BTParameterSpecEnum171")


@_attrs_define
class BTParameterSpecEnum171:
    """
    Attributes:
        ...
        enum_name (str | Unset):
        enum_option_visibility_conditions (BTEnumOptionVisibilityConditionList2936 | Unset):
        enum_value_to_visibility_condition (BTParameterSpecEnum171EnumValueToVisibilityCondition | Unset):
        namespace (str | Unset):
        option_icon_uris (list[str] | Unset):
        option_names (list[str] | Unset):
    ...
    enum_option_visibility_conditions: BTEnumOptionVisibilityConditionList2936 | Unset = UNSET
    enum_value_to_visibility_condition: BTParameterSpecEnum171EnumValueToVisibilityCondition | Unset = UNSET
    namespace: str | Unset = UNSET
    option_icon_uris: list[str] | Unset = UNSET
    option_names: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        enum_option_visibility_conditions: dict[str, Any] | Unset = UNSET
        if not isinstance(self.enum_option_visibility_conditions, Unset):
            enum_option_visibility_conditions = self.enum_option_visibility_conditions.to_dict()

        enum_value_to_visibility_condition: dict[str, Any] | Unset = UNSET
        if not isinstance(self.enum_value_to_visibility_condition, Unset):
            enum_value_to_visibility_condition = self.enum_value_to_visibility_condition.to_dict()

        namespace = self.namespace

        option_icon_uris: list[str] | Unset = UNSET
        if not isinstance(self.option_icon_uris, Unset):
            option_icon_uris = self.option_icon_uris

        option_names: list[str] | Unset = UNSET
        if not isinstance(self.option_names, Unset):
        ...
        if enum_option_visibility_conditions is not UNSET:
            field_dict["enumOptionVisibilityConditions"] = enum_option_visibility_conditions
        if enum_value_to_visibility_condition is not UNSET:
            field_dict["enumValueToVisibilityCondition"] = enum_value_to_visibility_condition
        if namespace is not UNSET:
            field_dict["namespace"] = namespace
        if option_icon_uris is not UNSET:
            field_dict["optionIconUris"] = option_icon_uris
        if option_names is not UNSET:
            field_dict["optionNames"] = option_names
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _enum_option_visibility_conditions = d.pop("enumOptionVisibilityConditions", UNSET)
        enum_option_visibility_conditions: BTEnumOptionVisibilityConditionList2936 | Unset
        if isinstance(_enum_option_visibility_conditions, Unset):
            enum_option_visibility_conditions = UNSET
        else:
            enum_option_visibility_conditions = BTEnumOptionVisibilityConditionList2936.from_dict(
                _enum_option_visibility_conditions
            )

        _enum_value_to_visibility_condition = d.pop("enumValueToVisibilityCondition", UNSET)
        enum_value_to_visibility_condition: BTParameterSpecEnum171EnumValueToVisibilityCondition | Unset
        if isinstance(_enum_value_to_visibility_condition, Unset):
            enum_value_to_visibility_condition = UNSET
        else:
            enum_value_to_visibility_condition = BTParameterSpecEnum171EnumValueToVisibilityCondition.from_dict(
                _enum_value_to_visibility_condition
            )

        namespace = d.pop("namespace", UNSET)

        option_icon_uris = cast(list[str], d.pop("optionIconUris", UNSET))

        option_names = cast(list[str], d.pop("optionNames", UNSET))

        options = cast(list[str], d.pop("options", UNSET))

        bt_parameter_spec_enum_171 = cls(
            ...
            enum_name=enum_name,
            enum_option_visibility_conditions=enum_option_visibility_conditions,
            enum_value_to_visibility_condition=enum_value_to_visibility_condition,
            namespace=namespace,
            option_icon_uris=option_icon_uris,
            option_names=option_names,
            options=options,
        )

        bt_parameter_spec_enum_171.additional_properties = d
        return bt_parameter_spec_enum_171
