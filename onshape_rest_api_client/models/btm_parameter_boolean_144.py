...
T = TypeVar("T", bound="BTMParameterBoolean144")


@_attrs_define
class BTMParameterBoolean144:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_boolean_144.additional_properties = d
        return btm_parameter_boolean_144
