...
T = TypeVar("T", bound="BTPStatementBreak272")


@_attrs_define
class BTPStatementBreak272:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        space_after_break (BTPSpace10 | Unset):
    """
    ...
    space_after_break: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_break: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_break, Unset):
            space_after_break = self.space_after_break.to_dict()
        ...
        if space_after_break is not UNSET:
            field_dict["spaceAfterBreak"] = space_after_break
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _space_after_break = d.pop("spaceAfterBreak", UNSET)
        space_after_break: BTPSpace10 | Unset
        if isinstance(_space_after_break, Unset):
            space_after_break = UNSET
        else:
            space_after_break = BTPSpace10.from_dict(_space_after_break)

        btp_statement_break_272 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            space_after_break=space_after_break,
        )

        btp_statement_break_272.additional_properties = d
        return btp_statement_break_272
