...
T = TypeVar("T", bound="BTLockedAtNamedPosition3201")


@_attrs_define
class BTLockedAtNamedPosition3201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_locked_at_named_position_3201 = cls(
            bt_type=bt_type,
            lock_type=lock_type,
        ...
        bt_locked_at_named_position_3201.additional_properties = d
        return bt_locked_at_named_position_3201
