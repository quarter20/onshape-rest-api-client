...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/featurespecs".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the specs for a Part Studio feature.
     ...
     Returns a list of feature specs available within the Part Studio. A feature spec provides a data
    description of the feature's interface to a feature.
