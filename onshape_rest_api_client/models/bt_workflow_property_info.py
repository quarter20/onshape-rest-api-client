...
if TYPE_CHECKING:
    ...
    from ..models.bt_workflow_property_info_default_value import BTWorkflowPropertyInfoDefaultValue
    from ..models.bt_workflow_property_info_initial_value import BTWorkflowPropertyInfoInitialValue
    from ..models.bt_workflow_property_info_value import BTWorkflowPropertyInfoValue
    from ..models.bt_workflowable_object_observer import BTWorkflowableObjectObserver


T = TypeVar("T", bound="BTWorkflowPropertyInfo")
...
class BTWorkflowPropertyInfo:
    ...
    Attributes:
        ...
        default_value (BTWorkflowPropertyInfoDefaultValue | Unset):
        dirty (bool | Unset):
        editable (bool | Unset):
        editable_in_ui (bool | Unset):
        enum_values (list[BTMetadataEnumValueInfo] | Unset):
        hide_in_ui (bool | Unset):
        initial_value (BTWorkflowPropertyInfoInitialValue | Unset):
        is_approver_property (bool | Unset):
        is_notifier_property (bool | Unset):
        multivalued (bool | Unset):
        name (str | Unset):
        observers (list[BTWorkflowableObjectObserver] | Unset):
        ...
        users_only (bool | Unset):
        validator (BTMetadataPropertyValidatorInfo | Unset):
        value (BTWorkflowPropertyInfoValue | Unset):
    ...
    default_value: BTWorkflowPropertyInfoDefaultValue | Unset = UNSET
    ...
    hide_in_ui: bool | Unset = UNSET
    initial_value: BTWorkflowPropertyInfoInitialValue | Unset = UNSET
    is_approver_property: bool | Unset = UNSET
    is_notifier_property: bool | Unset = UNSET
    multivalued: bool | Unset = UNSET
    name: str | Unset = UNSET
    observers: list[BTWorkflowableObjectObserver] | Unset = UNSET
    ...
    users_only: bool | Unset = UNSET
    validator: BTMetadataPropertyValidatorInfo | Unset = UNSET
    value: BTWorkflowPropertyInfoValue | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_approver_property = self.is_approver_property

        is_notifier_property = self.is_notifier_property

        multivalued = self.multivalued

        name = self.name

        observers: list[dict[str, Any]] | Unset = UNSET
        ...
        if hide_in_ui is not UNSET:
            field_dict["hideInUi"] = hide_in_ui
        if initial_value is not UNSET:
            field_dict["initialValue"] = initial_value
        if is_approver_property is not UNSET:
            field_dict["isApproverProperty"] = is_approver_property
        if is_notifier_property is not UNSET:
            field_dict["isNotifierProperty"] = is_notifier_property
        ...
        if teams_only is not UNSET:
            field_dict["teamsOnly"] = teams_only
        if ui_hints is not UNSET:
            field_dict["uiHints"] = ui_hints
        if users_only is not UNSET:
            field_dict["usersOnly"] = users_only
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_value, Unset):
            ...
            default_value = BTWorkflowPropertyInfoDefaultValue.from_dict(_default_value)
        ...
        hide_in_ui = d.pop("hideInUi", UNSET)
        ...
        if isinstance(_initial_value, Unset):
            ...
            initial_value = BTWorkflowPropertyInfoInitialValue.from_dict(_initial_value)

        is_approver_property = d.pop("isApproverProperty", UNSET)

        is_notifier_property = d.pop("isNotifierProperty", UNSET)

        multivalued = d.pop("multivalued", UNSET)

        name = d.pop("name", UNSET)

        _observers = d.pop("observers", UNSET)
        observers: list[BTWorkflowableObjectObserver] | Unset = UNSET
        if _observers is not UNSET:
            observers = []
            for observers_item_data in _observers:
                observers_item = BTWorkflowableObjectObserver.from_dict(observers_item_data)
        ...
        teams_only = d.pop("teamsOnly", UNSET)
        ...
        users_only = d.pop("usersOnly", UNSET)
        ...
        if isinstance(_value, Unset):
            ...
            value = BTWorkflowPropertyInfoValue.from_dict(_value)

        value_type = d.pop("valueType", UNSET)

        bt_workflow_property_info = cls(
            ...
            is_approver_property=is_approver_property,
            is_notifier_property=is_notifier_property,
        ...
        bt_workflow_property_info.additional_properties = d
        return bt_workflow_property_info
