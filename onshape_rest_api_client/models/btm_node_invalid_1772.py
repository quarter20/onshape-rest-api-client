...
T = TypeVar("T", bound="BTMNodeInvalid1772")


@_attrs_define
class BTMNodeInvalid1772:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_node_invalid_1772 = cls(
            bt_type=bt_type,
            import_microversion=import_microversion,
            node_id=node_id,
        )

        btm_node_invalid_1772.additional_properties = d
        return btm_node_invalid_1772
