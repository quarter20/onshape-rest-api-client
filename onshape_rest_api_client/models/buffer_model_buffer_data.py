...
T = TypeVar("T", bound="BufferModelBufferData")


@_attrs_define
class BufferModelBufferData:
    """
    Attributes:
        short (int | Unset):
        char (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        buffer_model_buffer_data.additional_properties = d
        return buffer_model_buffer_data
