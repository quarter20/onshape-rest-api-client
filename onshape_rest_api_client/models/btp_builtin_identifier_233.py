...
T = TypeVar("T", bound="BTPBuiltinIdentifier233")


@_attrs_define
class BTPBuiltinIdentifier233:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_builtin_identifier_233 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_builtin_identifier_233.additional_properties = d
        return btp_builtin_identifier_233
