...
T = TypeVar("T", bound="BTTeamSummaryInfo")


@_attrs_define
class BTTeamSummaryInfo:
    """
    Attributes:
        active (bool | Unset):
        can_move (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_team_summary_info.additional_properties = d
        return bt_team_summary_info
