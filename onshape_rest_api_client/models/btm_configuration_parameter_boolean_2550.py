...
T = TypeVar("T", bound="BTMConfigurationParameterBoolean2550")


@_attrs_define
class BTMConfigurationParameterBoolean2550:
    """
    Attributes:
    ...
    default_value: bool | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_configuration_parameter_boolean_2550 = cls(
            bt_type=bt_type,
        ...
        btm_configuration_parameter_boolean_2550.additional_properties = d
        return btm_configuration_parameter_boolean_2550
