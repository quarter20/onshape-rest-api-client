...
T = TypeVar("T", bound="BTParameterSpecDatabase1071")


@_attrs_define
class BTParameterSpecDatabase1071:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_database_1071 = cls(
        ...
        bt_parameter_spec_database_1071.additional_properties = d
        return bt_parameter_spec_database_1071
