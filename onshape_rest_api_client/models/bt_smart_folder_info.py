...
if TYPE_CHECKING:
    ...
    from ..models.bt_smart_folder_predicate_info import BTSmartFolderPredicateInfo
    from ..models.bt_smart_folder_sort_info import BTSmartFolderSortInfo
    from ..models.bt_user_basic_summary_info import BTUserBasicSummaryInfo


T = TypeVar("T", bound="BTSmartFolderInfo")


@_attrs_define
class BTSmartFolderInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
        ...
        predicates (list[BTSmartFolderPredicateInfo] | Unset):
        sort (list[BTSmartFolderSortInfo] | Unset):
    """
    ...
    predicates: list[BTSmartFolderPredicateInfo] | Unset = UNSET
    sort: list[BTSmartFolderSortInfo] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        predicates: list[dict[str, Any]] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        predicates: list[BTSmartFolderPredicateInfo] | Unset = UNSET
        if _predicates is not UNSET:
            predicates = []
            for predicates_item_data in _predicates:
                predicates_item = BTSmartFolderPredicateInfo.from_dict(predicates_item_data)
        ...
        if _sort is not UNSET:
            ...
            for sort_item_data in _sort:
                sort_item = BTSmartFolderSortInfo.from_dict(sort_item_data)

                sort.append(sort_item)

        bt_smart_folder_info = cls(
            json_type=json_type,
            can_move=can_move,
        ...
        bt_smart_folder_info.additional_properties = d
        return bt_smart_folder_info
