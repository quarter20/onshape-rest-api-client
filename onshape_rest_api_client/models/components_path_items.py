...
T = TypeVar("T", bound="ComponentsPathItems")


@_attrs_define
class ComponentsPathItems:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        components_path_items.additional_properties = additional_properties
        return components_path_items
