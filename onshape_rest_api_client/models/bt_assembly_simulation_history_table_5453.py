...
T = TypeVar("T", bound="BTAssemblySimulationHistoryTable5453")


@_attrs_define
class BTAssemblySimulationHistoryTable5453:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_assembly_simulation_history_table_5453 = cls(
        ...
        bt_assembly_simulation_history_table_5453.additional_properties = d
        return bt_assembly_simulation_history_table_5453
