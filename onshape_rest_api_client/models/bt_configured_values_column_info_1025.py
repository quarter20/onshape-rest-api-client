...
T = TypeVar("T", bound="BTConfiguredValuesColumnInfo1025")


@_attrs_define
class BTConfiguredValuesColumnInfo1025:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_configured_values_column_info_1025 = cls(
            bt_type=bt_type,
            id=id,
            node_id=node_id,
        ...
        bt_configured_values_column_info_1025.additional_properties = d
        return bt_configured_values_column_info_1025
