...
T = TypeVar("T", bound="BTPExpressionAs238")


@_attrs_define
class BTPExpressionAs238:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_expression_as_238.additional_properties = d
        return btp_expression_as_238
