...
if TYPE_CHECKING:
    from ..models.create_translation_body_file import CreateTranslationBodyFile


T = TypeVar("T", bound="CreateTranslationBody")


@_attrs_define
class CreateTranslationBody:
    """
    Attributes:
        file (CreateTranslationBodyFile | Unset): The file to upload.
    ...
    file: CreateTranslationBodyFile | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file: CreateTranslationBodyFile | Unset
        if isinstance(_file, Unset):
            file = UNSET
        else:
            file = CreateTranslationBodyFile.from_dict(_file)
        ...
        create_translation_body.additional_properties = d
        return create_translation_body
