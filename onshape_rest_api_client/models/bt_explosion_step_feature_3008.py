...
T = TypeVar("T", bound="BTExplosionStepFeature3008")


@_attrs_define
class BTExplosionStepFeature3008:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_explosion_step_feature_3008 = cls(
            bt_type=bt_type,
        ...
        bt_explosion_step_feature_3008.additional_properties = d
        return bt_explosion_step_feature_3008
