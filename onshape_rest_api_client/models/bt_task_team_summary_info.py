...
T = TypeVar("T", bound="BTTaskTeamSummaryInfo")


@_attrs_define
class BTTaskTeamSummaryInfo:
    """
    Attributes:
        acted (bool | Unset):
        active (bool | Unset):
        ...
        parent_id (str | Unset):
        predefined_team (int | Unset):
        predefined_team_mutable (bool | Unset):
    ...
    predefined_team: int | Unset = UNSET
    predefined_team_mutable: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        predefined_team = self.predefined_team

        predefined_team_mutable = self.predefined_team_mutable
        ...
        if predefined_team is not UNSET:
            field_dict["predefinedTeam"] = predefined_team
        if predefined_team_mutable is not UNSET:
            field_dict["predefinedTeamMutable"] = predefined_team_mutable
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        predefined_team = d.pop("predefinedTeam", UNSET)

        predefined_team_mutable = d.pop("predefinedTeamMutable", UNSET)
        ...
        bt_task_team_summary_info = cls(
            ...
            predefined_team_mutable=predefined_team_mutable,
        ...
        bt_task_team_summary_info.additional_properties = d
        return bt_task_team_summary_info
