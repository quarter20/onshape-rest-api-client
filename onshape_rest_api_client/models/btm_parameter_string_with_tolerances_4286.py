...
if TYPE_CHECKING:
    from ..models.bt_tolerance_string_3274 import BTToleranceString3274


T = TypeVar("T", bound="BTMParameterStringWithTolerances4286")


@_attrs_define
class BTMParameterStringWithTolerances4286:
    """
    Attributes:
        ...
        components (list[BTToleranceString3274] | Unset):
    """
    ...
    components: list[BTToleranceString3274] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _components is not UNSET:
            ...
            for components_item_data in _components:
                components_item = BTToleranceString3274.from_dict(components_item_data)

                components.append(components_item)

        btm_parameter_string_with_tolerances_4286 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_string_with_tolerances_4286.additional_properties = d
        return btm_parameter_string_with_tolerances_4286
