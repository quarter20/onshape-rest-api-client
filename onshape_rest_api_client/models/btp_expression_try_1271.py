...
T = TypeVar("T", bound="BTPExpressionTry1271")


@_attrs_define
class BTPExpressionTry1271:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        silent (bool | Unset):
        space_after_silent (BTPSpace10 | Unset):
        space_after_try (BTPSpace10 | Unset):
    """
    ...
    space_after_silent: BTPSpace10 | Unset = UNSET
    space_after_try: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_silent: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_silent, Unset):
            space_after_silent = self.space_after_silent.to_dict()

        space_after_try: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_try, Unset):
            space_after_try = self.space_after_try.to_dict()
        ...
        if space_after_silent is not UNSET:
            field_dict["spaceAfterSilent"] = space_after_silent
        if space_after_try is not UNSET:
            field_dict["spaceAfterTry"] = space_after_try
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _space_after_silent = d.pop("spaceAfterSilent", UNSET)
        space_after_silent: BTPSpace10 | Unset
        if isinstance(_space_after_silent, Unset):
            space_after_silent = UNSET
        else:
            space_after_silent = BTPSpace10.from_dict(_space_after_silent)

        _space_after_try = d.pop("spaceAfterTry", UNSET)
        space_after_try: BTPSpace10 | Unset
        if isinstance(_space_after_try, Unset):
            space_after_try = UNSET
        else:
            space_after_try = BTPSpace10.from_dict(_space_after_try)

        btp_expression_try_1271 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            silent=silent,
            space_after_silent=space_after_silent,
            space_after_try=space_after_try,
        )

        btp_expression_try_1271.additional_properties = d
        return btp_expression_try_1271
