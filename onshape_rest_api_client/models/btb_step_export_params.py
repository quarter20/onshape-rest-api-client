...
T = TypeVar("T", bound="BTBStepExportParams")


@_attrs_define
class BTBStepExportParams:
    ...
    Attributes:
        ...
        step_unit (GBTExportUnit | Unset): Units to export the model with.
    ...
    step_unit: GBTExportUnit | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        step_unit: str | Unset = UNSET
        if not isinstance(self.step_unit, Unset):
            step_unit = self.step_unit.value
        ...
        if step_unit is not UNSET:
            field_dict["stepUnit"] = step_unit
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _step_unit = d.pop("stepUnit", UNSET)
        step_unit: GBTExportUnit | Unset
        if isinstance(_step_unit, Unset):
            step_unit = UNSET
        else:
            step_unit = GBTExportUnit(_step_unit)
        ...
        btb_step_export_params.additional_properties = d
        return btb_step_export_params
