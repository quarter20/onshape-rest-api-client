...
from ...models.get_associative_data_wvm import GetAssociativeDataWvm
from ...types import UNSET, Response, Unset


def _get_kwargs(
    did: str,
    wvm: GetAssociativeDataWvm,
    wvmid: str,
    eid: str,
    *,
    ...
    params["returnIdTags"] = return_id_tags
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        return_id_tags (bool | Unset):  Default: False.
