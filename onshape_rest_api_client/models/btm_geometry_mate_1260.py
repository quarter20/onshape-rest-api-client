...
T = TypeVar("T", bound="BTMGeometryMate1260")


@_attrs_define
class BTMGeometryMate1260:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_geometry_mate_1260.additional_properties = d
        return btm_geometry_mate_1260
