...
if TYPE_CHECKING:
    from ..models.bt_individual_table_properties_3760 import BTIndividualTableProperties3760
    ...
    from ..models.btfs_table_953_hidden_column_ids_to_names import BTFSTable953HiddenColumnIdsToNames


T = TypeVar("T", bound="BTFSTable953")
...
class BTFSTable953:
    ...
    Attributes:
        ...
        hidden_column_ids_to_names (BTFSTable953HiddenColumnIdsToNames | Unset):
        individual_table_properties (BTIndividualTableProperties3760 | Unset):
    """
    ...
    hidden_column_ids_to_names: BTFSTable953HiddenColumnIdsToNames | Unset = UNSET
    individual_table_properties: BTIndividualTableProperties3760 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        hidden_column_ids_to_names: dict[str, Any] | Unset = UNSET
        if not isinstance(self.hidden_column_ids_to_names, Unset):
            hidden_column_ids_to_names = self.hidden_column_ids_to_names.to_dict()

        individual_table_properties: dict[str, Any] | Unset = UNSET
        if not isinstance(self.individual_table_properties, Unset):
            individual_table_properties = self.individual_table_properties.to_dict()
        ...
        if hidden_column_ids_to_names is not UNSET:
            field_dict["hiddenColumnIdsToNames"] = hidden_column_ids_to_names
        if individual_table_properties is not UNSET:
            field_dict["individualTableProperties"] = individual_table_properties
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _hidden_column_ids_to_names = d.pop("hiddenColumnIdsToNames", UNSET)
        hidden_column_ids_to_names: BTFSTable953HiddenColumnIdsToNames | Unset
        if isinstance(_hidden_column_ids_to_names, Unset):
            hidden_column_ids_to_names = UNSET
        else:
            hidden_column_ids_to_names = BTFSTable953HiddenColumnIdsToNames.from_dict(_hidden_column_ids_to_names)

        _individual_table_properties = d.pop("individualTableProperties", UNSET)
        individual_table_properties: BTIndividualTableProperties3760 | Unset
        if isinstance(_individual_table_properties, Unset):
            individual_table_properties = UNSET
        else:
            individual_table_properties = BTIndividualTableProperties3760.from_dict(_individual_table_properties)
        ...
        btfs_table_953 = cls(
            ...
            hidden_column_ids_to_names=hidden_column_ids_to_names,
            individual_table_properties=individual_table_properties,
        )

        btfs_table_953.additional_properties = d
        return btfs_table_953
