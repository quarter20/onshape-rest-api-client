...
T = TypeVar("T", bound="BTMSketchTextEntity1761")


@_attrs_define
class BTMSketchTextEntity1761:
    """
    Attributes:
        ...
        ascent (float | Unset):
        baseline_direction_x (float | Unset):
        baseline_direction_y (float | Unset):
        baseline_start_x (float | Unset):
        baseline_start_y (float | Unset):
        font_name (str | Unset):
        text (str | Unset):
    """
    ...
    baseline_direction_x: float | Unset = UNSET
    baseline_direction_y: float | Unset = UNSET
    baseline_start_x: float | Unset = UNSET
    baseline_start_y: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        baseline_direction_x = self.baseline_direction_x

        baseline_direction_y = self.baseline_direction_y

        baseline_start_x = self.baseline_start_x

        baseline_start_y = self.baseline_start_y
        ...
        if baseline_direction_x is not UNSET:
            field_dict["baselineDirectionX"] = baseline_direction_x
        if baseline_direction_y is not UNSET:
            field_dict["baselineDirectionY"] = baseline_direction_y
        if baseline_start_x is not UNSET:
            field_dict["baselineStartX"] = baseline_start_x
        if baseline_start_y is not UNSET:
            field_dict["baselineStartY"] = baseline_start_y
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        baseline_direction_x = d.pop("baselineDirectionX", UNSET)

        baseline_direction_y = d.pop("baselineDirectionY", UNSET)

        baseline_start_x = d.pop("baselineStartX", UNSET)

        baseline_start_y = d.pop("baselineStartY", UNSET)

        font_name = d.pop("fontName", UNSET)

        text = d.pop("text", UNSET)

        btm_sketch_text_entity_1761 = cls(
            bt_type=bt_type,
        ...
        btm_sketch_text_entity_1761.additional_properties = d
        return btm_sketch_text_entity_1761
