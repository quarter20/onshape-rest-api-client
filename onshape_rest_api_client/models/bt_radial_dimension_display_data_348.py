...
from ..models.gbt_radius_display import GBTRadiusDisplay
...
T = TypeVar("T", bound="BTRadialDimensionDisplayData348")
...
class BTRadialDimensionDisplayData348:
    ...
    Attributes:
        ...
        radius_display (GBTRadiusDisplay | Unset):
        real_diameter (bool | Unset):
    ...
    radius_display: GBTRadiusDisplay | Unset = UNSET
    real_diameter: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        radius_display: str | Unset = UNSET
        if not isinstance(self.radius_display, Unset):
            radius_display = self.radius_display.value

        real_diameter = self.real_diameter
        ...
        if radius_display is not UNSET:
            field_dict["radiusDisplay"] = radius_display
        if real_diameter is not UNSET:
            field_dict["realDiameter"] = real_diameter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _radius_display = d.pop("radiusDisplay", UNSET)
        radius_display: GBTRadiusDisplay | Unset
        if isinstance(_radius_display, Unset):
            radius_display = UNSET
        else:
            radius_display = GBTRadiusDisplay(_radius_display)

        real_diameter = d.pop("realDiameter", UNSET)
        ...
        bt_radial_dimension_display_data_348.additional_properties = d
        return bt_radial_dimension_display_data_348
