...
T = TypeVar("T", bound="BTMConfigurationParameterList5548")


@_attrs_define
class BTMConfigurationParameterList5548:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_configuration_parameter_list_5548 = cls(
            bt_type=bt_type,
            import_microversion=import_microversion,
            node_id=node_id,
        )

        btm_configuration_parameter_list_5548.additional_properties = d
        return btm_configuration_parameter_list_5548
