...
T = TypeVar("T", bound="BTLockedAtSubAssemblyPosition3885")


@_attrs_define
class BTLockedAtSubAssemblyPosition3885:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_locked_at_sub_assembly_position_3885 = cls(
            bt_type=bt_type,
            lock_type=lock_type,
            locked_sub_assembly_output_info=locked_sub_assembly_output_info,
        )

        bt_locked_at_sub_assembly_position_3885.additional_properties = d
        return bt_locked_at_sub_assembly_position_3885
