...
T = TypeVar("T", bound="BTExplosion2754")


@_attrs_define
class BTExplosion2754:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.explode_steps, Unset):
            explode_steps = []
            for explode_steps_item_data in self.explode_steps:
                explode_steps_item = explode_steps_item_data.to_dict()
                explode_steps.append(explode_steps_item)

        starting_position_id: dict[str, Any] | Unset = UNSET
        if not isinstance(self.starting_position_id, Unset):
            starting_position_id = self.starting_position_id.to_dict()
        ...
        if explode_steps is not UNSET:
            field_dict["explodeSteps"] = explode_steps
        if starting_position_id is not UNSET:
            field_dict["startingPositionId"] = starting_position_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        explode_steps: list[BTExplosionStepFeature3008] | Unset = UNSET
        if _explode_steps is not UNSET:
            explode_steps = []
            for explode_steps_item_data in _explode_steps:
                explode_steps_item = BTExplosionStepFeature3008.from_dict(explode_steps_item_data)

                explode_steps.append(explode_steps_item)

        _starting_position_id = d.pop("startingPositionId", UNSET)
        starting_position_id: BTMicroversionIdAndConfiguration2338 | Unset
        if isinstance(_starting_position_id, Unset):
            starting_position_id = UNSET
        else:
            starting_position_id = BTMicroversionIdAndConfiguration2338.from_dict(_starting_position_id)

        bt_explosion_2754 = cls(
            bt_type=bt_type,
        ...
        bt_explosion_2754.additional_properties = d
        return bt_explosion_2754
