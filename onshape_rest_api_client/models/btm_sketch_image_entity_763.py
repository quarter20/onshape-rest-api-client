...
T = TypeVar("T", bound="BTMSketchImageEntity763")


@_attrs_define
class BTMSketchImageEntity763:
    """
    Attributes:
    ...
    xaxis_x: float | Unset = UNSET
    xaxis_y: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        xaxis_x = self.xaxis_x

        xaxis_y = self.xaxis_y
        ...
        if origin_x is not UNSET:
            field_dict["originX"] = origin_x
        if origin_y is not UNSET:
            field_dict["originY"] = origin_y
        if xaxis_x is not UNSET:
            field_dict["xaxisX"] = xaxis_x
        if xaxis_y is not UNSET:
            field_dict["xaxisY"] = xaxis_y
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        origin_x = d.pop("originX", UNSET)

        origin_y = d.pop("originY", UNSET)

        xaxis_x = d.pop("xaxisX", UNSET)

        xaxis_y = d.pop("xaxisY", UNSET)

        btm_sketch_image_entity_763 = cls(
            bt_type=bt_type,
        ...
        btm_sketch_image_entity_763.additional_properties = d
        return btm_sketch_image_entity_763
