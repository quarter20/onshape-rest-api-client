...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/assemblies/d/{did}/{wv}/{wvid}/e/{eid}/translations".format(
...
def sync_detailed(
    ...
    * Use `formatName` in the JSON request body to specify the export file type. Use
    ...
    export file formats. Confirm that `couldBeAssembly=true.`
    * Set `storeInDocument` to `false` to export to a data file. Set to `true` to export to a blob
    element in the same document.
    * See [API Guide: Import & Export ](https://onshape-public.github.io/docs/api-
    adv/translation/#export-an-assembly-to-another-format) for more details.
