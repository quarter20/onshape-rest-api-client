...
if TYPE_CHECKING:
    from ..models.bt_update_features_response_1333_feature_states import BTUpdateFeaturesResponse1333FeatureStates
    from ..models.btm_feature_134 import BTMFeature134


T = TypeVar("T", bound="BTUpdateFeaturesResponse1333")


@_attrs_define
class BTUpdateFeaturesResponse1333:
    """
    Attributes:
        bt_type (str | Unset): Type of JSON object.
        feature_states (BTUpdateFeaturesResponse1333FeatureStates | Unset):
    ...
    feature_states: BTUpdateFeaturesResponse1333FeatureStates | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_feature_states, Unset):
            ...
            feature_states = BTUpdateFeaturesResponse1333FeatureStates.from_dict(_feature_states)
        ...
        bt_update_features_response_1333 = cls(
            bt_type=bt_type,
        ...
        bt_update_features_response_1333.additional_properties = d
        return bt_update_features_response_1333
