...
T = TypeVar("T", bound="GBTCreateElementMessageBody")


@_attrs_define
class GBTCreateElementMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_create_element_message_body = cls(
        ...
        gbt_create_element_message_body.additional_properties = d
        return gbt_create_element_message_body
