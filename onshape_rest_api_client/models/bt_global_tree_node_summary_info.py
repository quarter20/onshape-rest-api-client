...
T = TypeVar("T", bound="BTGlobalTreeNodeSummaryInfo")


@_attrs_define
class BTGlobalTreeNodeSummaryInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_global_tree_node_summary_info = cls(
            json_type=json_type,
            can_move=can_move,
        ...
        bt_global_tree_node_summary_info.additional_properties = d
        return bt_global_tree_node_summary_info
