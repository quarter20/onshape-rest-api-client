...
T = TypeVar("T", bound="BTUpdateFeaturesResponse1333FeatureStates")


@_attrs_define
class BTUpdateFeaturesResponse1333FeatureStates:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        bt_update_features_response_1333_feature_states = cls()
        ...
        bt_update_features_response_1333_feature_states.additional_properties = additional_properties
        return bt_update_features_response_1333_feature_states
