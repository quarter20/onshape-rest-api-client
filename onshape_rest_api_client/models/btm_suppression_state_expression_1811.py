...
if TYPE_CHECKING:
    from ..models.btm_parameter_quantity_147 import BTMParameterQuantity147


T = TypeVar("T", bound="BTMSuppressionStateExpression1811")


@_attrs_define
class BTMSuppressionStateExpression1811:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_value, Unset):
            ...
            value = BTMParameterQuantity147.from_dict(_value)

        btm_suppression_state_expression_1811 = cls(
            bt_type=bt_type,
        ...
        btm_suppression_state_expression_1811.additional_properties = d
        return btm_suppression_state_expression_1811
