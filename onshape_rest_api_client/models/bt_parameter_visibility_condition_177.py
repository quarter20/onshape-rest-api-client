...
T = TypeVar("T", bound="BTParameterVisibilityCondition177")


@_attrs_define
class BTParameterVisibilityCondition177:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_visibility_condition_177 = cls(
            bt_type=bt_type,
            self_or_child_always_visible=self_or_child_always_visible,
        )

        bt_parameter_visibility_condition_177.additional_properties = d
        return bt_parameter_visibility_condition_177
