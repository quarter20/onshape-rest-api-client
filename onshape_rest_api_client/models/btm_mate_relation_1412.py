...
T = TypeVar("T", bound="BTMMateRelation1412")


@_attrs_define
class BTMMateRelation1412:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_mate_relation_1412.additional_properties = d
        return btm_mate_relation_1412
