...
if TYPE_CHECKING:
    ...
    from ..models.bt_inherited_acl_info import BTInheritedAclInfo
    from ..models.bt_owner_info import BTOwnerInfo


T = TypeVar("T", bound="BTAclInfo")
...
class BTAclInfo:
    ...
    Attributes:
        ...
        inherited_acls (list[BTInheritedAclInfo] | Unset):
    ...
    id: str | Unset = UNSET
    inherited_acls: list[BTInheritedAclInfo] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        inherited_acls: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.inherited_acls, Unset):
            inherited_acls = []
            for inherited_acls_item_data in self.inherited_acls:
                inherited_acls_item = inherited_acls_item_data.to_dict()
                inherited_acls.append(inherited_acls_item)
        ...
        if id is not UNSET:
            field_dict["id"] = id
        if inherited_acls is not UNSET:
            field_dict["inheritedAcls"] = inherited_acls
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _inherited_acls = d.pop("inheritedAcls", UNSET)
        inherited_acls: list[BTInheritedAclInfo] | Unset = UNSET
        if _inherited_acls is not UNSET:
            inherited_acls = []
            for inherited_acls_item_data in _inherited_acls:
                inherited_acls_item = BTInheritedAclInfo.from_dict(inherited_acls_item_data)
        ...
        bt_acl_info.additional_properties = d
        return bt_acl_info
