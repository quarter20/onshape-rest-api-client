...
T = TypeVar("T", bound="BTMParameterEnum145")


@_attrs_define
class BTMParameterEnum145:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_enum_145.additional_properties = d
        return btm_parameter_enum_145
