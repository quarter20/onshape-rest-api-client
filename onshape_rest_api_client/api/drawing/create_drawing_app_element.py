...
from ...models.bt_drawing_params import BTDrawingParams
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/drawings/d/{did}/w/{wid}/create".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create a new drawing in a document.
     ...
     This endpoint takes a JSON Schema as input. See the schema docs below for details, and see [API
    Guide: Drawings](https://onshape-public.github.io/docs/api-adv/drawings/) for more information.

    Args:
        did (str):
        wid (str):
        body (BTDrawingParams): JSON schema for creating or updating a drawing.
