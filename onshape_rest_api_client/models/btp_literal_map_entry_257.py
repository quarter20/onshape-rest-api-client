...
T = TypeVar("T", bound="BTPLiteralMapEntry257")


@_attrs_define
class BTPLiteralMapEntry257:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        key (BTPPropertyAccessor23 | Unset):
    ...
    key: BTPPropertyAccessor23 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_key, Unset):
            ...
            key = BTPPropertyAccessor23.from_dict(_key)
        ...
        btp_literal_map_entry_257.additional_properties = d
        return btp_literal_map_entry_257
