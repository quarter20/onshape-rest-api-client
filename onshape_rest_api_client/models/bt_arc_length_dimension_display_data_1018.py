...
T = TypeVar("T", bound="BTArcLengthDimensionDisplayData1018")


@_attrs_define
class BTArcLengthDimensionDisplayData1018:
    """
    Attributes:
        ...
        witness_end_point_0_t (float | Unset):
        witness_end_point_1_r (float | Unset):
        witness_end_point_1_t (float | Unset):
        witness_max_point_0_r (float | Unset):
        witness_max_point_1_r (float | Unset):
        witness_min_point_0_r (float | Unset):
    ...
    witness_end_point_0_t: float | Unset = UNSET
    witness_end_point_1_r: float | Unset = UNSET
    witness_end_point_1_t: float | Unset = UNSET
    witness_max_point_0_r: float | Unset = UNSET
    witness_max_point_1_r: float | Unset = UNSET
    witness_min_point_0_r: float | Unset = UNSET
    witness_min_point_1_r: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        witness_end_point_0_r = self.witness_end_point_0_r

        witness_end_point_0_t = self.witness_end_point_0_t

        witness_end_point_1_r = self.witness_end_point_1_r

        witness_end_point_1_t = self.witness_end_point_1_t

        witness_max_point_0_r = self.witness_max_point_0_r

        witness_max_point_1_r = self.witness_max_point_1_r

        witness_min_point_0_r = self.witness_min_point_0_r

        witness_min_point_1_r = self.witness_min_point_1_r
        ...
        if position_t is not UNSET:
            field_dict["positionT"] = position_t
        if witness_end_point_0_r is not UNSET:
            field_dict["witnessEndPoint0r"] = witness_end_point_0_r
        if witness_end_point_0_t is not UNSET:
            field_dict["witnessEndPoint0t"] = witness_end_point_0_t
        if witness_end_point_1_r is not UNSET:
            field_dict["witnessEndPoint1r"] = witness_end_point_1_r
        if witness_end_point_1_t is not UNSET:
            field_dict["witnessEndPoint1t"] = witness_end_point_1_t
        if witness_max_point_0_r is not UNSET:
            field_dict["witnessMaxPoint0r"] = witness_max_point_0_r
        if witness_max_point_1_r is not UNSET:
            field_dict["witnessMaxPoint1r"] = witness_max_point_1_r
        if witness_min_point_0_r is not UNSET:
            field_dict["witnessMinPoint0r"] = witness_min_point_0_r
        if witness_min_point_1_r is not UNSET:
            field_dict["witnessMinPoint1r"] = witness_min_point_1_r
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        witness_end_point_0_r = d.pop("witnessEndPoint0r", UNSET)

        witness_end_point_0_t = d.pop("witnessEndPoint0t", UNSET)

        witness_end_point_1_r = d.pop("witnessEndPoint1r", UNSET)

        witness_end_point_1_t = d.pop("witnessEndPoint1t", UNSET)

        witness_max_point_0_r = d.pop("witnessMaxPoint0r", UNSET)

        witness_max_point_1_r = d.pop("witnessMaxPoint1r", UNSET)

        witness_min_point_0_r = d.pop("witnessMinPoint0r", UNSET)

        witness_min_point_1_r = d.pop("witnessMinPoint1r", UNSET)

        bt_arc_length_dimension_display_data_1018 = cls(
            bt_type=bt_type,
            ...
            witness_end_point_0_t=witness_end_point_0_t,
            witness_end_point_1_r=witness_end_point_1_r,
            witness_end_point_1_t=witness_end_point_1_t,
            witness_max_point_0_r=witness_max_point_0_r,
            witness_max_point_1_r=witness_max_point_1_r,
            witness_min_point_0_r=witness_min_point_0_r,
            witness_min_point_1_r=witness_min_point_1_r,
        )

        bt_arc_length_dimension_display_data_1018.additional_properties = d
        return bt_arc_length_dimension_display_data_1018
