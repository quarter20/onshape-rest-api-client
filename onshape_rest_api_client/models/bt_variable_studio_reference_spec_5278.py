...
T = TypeVar("T", bound="BTVariableStudioReferenceSpec5278")


@_attrs_define
class BTVariableStudioReferenceSpec5278:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_variable_studio_reference_spec_5278 = cls(
        ...
        bt_variable_studio_reference_spec_5278.additional_properties = d
        return bt_variable_studio_reference_spec_5278
