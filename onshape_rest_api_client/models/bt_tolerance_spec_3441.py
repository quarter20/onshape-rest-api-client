...
T = TypeVar("T", bound="BTToleranceSpec3441")


@_attrs_define
class BTToleranceSpec3441:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_tolerance_spec_3441.additional_properties = d
        return bt_tolerance_spec_3441
