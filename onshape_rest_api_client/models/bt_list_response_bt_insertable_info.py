...
T = TypeVar("T", bound="BTListResponseBTInsertableInfo")


@_attrs_define
class BTListResponseBTInsertableInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_list_response_bt_insertable_info = cls(
            href=href,
            items=items,
            next_=next_,
            previous=previous,
        ...
        bt_list_response_bt_insertable_info.additional_properties = d
        return bt_list_response_bt_insertable_info
