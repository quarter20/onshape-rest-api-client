...
if TYPE_CHECKING:
    ...
    from ..models.btm_enum_option_592 import BTMEnumOption592


T = TypeVar("T", bound="BTMConfigurationParameterEnum105")


@_attrs_define
class BTMConfigurationParameterEnum105:
    """
    Attributes:
        ...
        namespace (str | Unset):
        option_ids (list[str] | Unset):
        option_names (list[str] | Unset):
        options (list[BTMEnumOption592] | Unset):
    """
    ...
    option_ids: list[str] | Unset = UNSET
    option_names: list[str] | Unset = UNSET
    options: list[BTMEnumOption592] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        option_ids: list[str] | Unset = UNSET
        if not isinstance(self.option_ids, Unset):
        ...
        if option_ids is not UNSET:
            field_dict["optionIds"] = option_ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        option_ids = cast(list[str], d.pop("optionIds", UNSET))
        ...
        if _options is not UNSET:
            ...
            for options_item_data in _options:
                options_item = BTMEnumOption592.from_dict(options_item_data)

                options.append(options_item)

        btm_configuration_parameter_enum_105 = cls(
            bt_type=bt_type,
        ...
        btm_configuration_parameter_enum_105.additional_properties = d
        return btm_configuration_parameter_enum_105
