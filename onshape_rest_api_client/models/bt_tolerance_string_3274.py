...
T = TypeVar("T", bound="BTToleranceString3274")


@_attrs_define
class BTToleranceString3274:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_tolerance_string_3274.additional_properties = d
        return bt_tolerance_string_3274
