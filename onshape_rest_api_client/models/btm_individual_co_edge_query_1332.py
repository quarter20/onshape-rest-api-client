...
T = TypeVar("T", bound="BTMIndividualCoEdgeQuery1332")


@_attrs_define
class BTMIndividualCoEdgeQuery1332:
    """
    Attributes:
        ...
        edge_query (BTMIndividualQuery138 | Unset):
        face_query (BTMIndividualQuery138 | Unset):
    """
    ...
    edge_query: BTMIndividualQuery138 | Unset = UNSET
    face_query: BTMIndividualQuery138 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        edge_query: dict[str, Any] | Unset = UNSET
        if not isinstance(self.edge_query, Unset):
            edge_query = self.edge_query.to_dict()

        face_query: dict[str, Any] | Unset = UNSET
        if not isinstance(self.face_query, Unset):
            face_query = self.face_query.to_dict()
        ...
        if edge_query is not UNSET:
            field_dict["edgeQuery"] = edge_query
        if face_query is not UNSET:
            field_dict["faceQuery"] = face_query
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _edge_query = d.pop("edgeQuery", UNSET)
        edge_query: BTMIndividualQuery138 | Unset
        if isinstance(_edge_query, Unset):
            edge_query = UNSET
        else:
            edge_query = BTMIndividualQuery138.from_dict(_edge_query)

        _face_query = d.pop("faceQuery", UNSET)
        face_query: BTMIndividualQuery138 | Unset
        if isinstance(_face_query, Unset):
            face_query = UNSET
        else:
            face_query = BTMIndividualQuery138.from_dict(_face_query)

        btm_individual_co_edge_query_1332 = cls(
            bt_type=bt_type,
        ...
        btm_individual_co_edge_query_1332.additional_properties = d
        return btm_individual_co_edge_query_1332
