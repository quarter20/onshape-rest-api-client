...
T = TypeVar("T", bound="BTBillOfMaterialsRowInfoSelectedMetadataEnumValues")


@_attrs_define
class BTBillOfMaterialsRowInfoSelectedMetadataEnumValues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        bt_bill_of_materials_row_info_selected_metadata_enum_values = cls()
        ...
        bt_bill_of_materials_row_info_selected_metadata_enum_values.additional_properties = additional_properties
        return bt_bill_of_materials_row_info_selected_metadata_enum_values
