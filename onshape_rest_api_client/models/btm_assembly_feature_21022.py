...
T = TypeVar("T", bound="BTMAssemblyFeature21022")


@_attrs_define
class BTMAssemblyFeature21022:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_assembly_feature_21022 = cls(
            bt_type=bt_type,
        ...
        btm_assembly_feature_21022.additional_properties = d
        return btm_assembly_feature_21022
