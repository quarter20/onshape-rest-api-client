...
T = TypeVar("T", bound="BTMIndividualParametricQuery3477")


@_attrs_define
class BTMIndividualParametricQuery3477:
    """
    Attributes:
        ...
        escaped_query_variable_name (str | Unset):
        query_variable_name (str | Unset):
    """
    ...
    escaped_query_variable_name: str | Unset = UNSET
    query_variable_name: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        escaped_query_variable_name = self.escaped_query_variable_name
        ...
        if escaped_query_variable_name is not UNSET:
            field_dict["escapedQueryVariableName"] = escaped_query_variable_name
        if query_variable_name is not UNSET:
            field_dict["queryVariableName"] = query_variable_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escaped_query_variable_name = d.pop("escapedQueryVariableName", UNSET)

        query_variable_name = d.pop("queryVariableName", UNSET)

        btm_individual_parametric_query_3477 = cls(
            bt_type=bt_type,
            ...
            escaped_query_variable_name=escaped_query_variable_name,
            query_variable_name=query_variable_name,
        )

        btm_individual_parametric_query_3477.additional_properties = d
        return btm_individual_parametric_query_3477
