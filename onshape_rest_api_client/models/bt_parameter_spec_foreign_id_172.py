...
T = TypeVar("T", bound="BTParameterSpecForeignId172")


@_attrs_define
class BTParameterSpecForeignId172:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_foreign_id_172 = cls(
        ...
        bt_parameter_spec_foreign_id_172.additional_properties = d
        return bt_parameter_spec_foreign_id_172
