...
T = TypeVar("T", bound="GBTRemoveUserFromCompanyMessageBody")


@_attrs_define
class GBTRemoveUserFromCompanyMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_remove_user_from_company_message_body = cls(
        ...
        gbt_remove_user_from_company_message_body.additional_properties = d
        return gbt_remove_user_from_company_message_body
