...
T = TypeVar("T", bound="BTSimulationInstance3093")


@_attrs_define
class BTSimulationInstance3093:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if is_modal is not UNSET:
            field_dict["isModal"] = is_modal
        if simulation_id is not UNSET:
            field_dict["simulationId"] = simulation_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_modal = d.pop("isModal", UNSET)

        simulation_id = d.pop("simulationId", UNSET)

        bt_simulation_instance_3093 = cls(
            bt_type=bt_type,
        ...
        bt_simulation_instance_3093.additional_properties = d
        return bt_simulation_instance_3093
