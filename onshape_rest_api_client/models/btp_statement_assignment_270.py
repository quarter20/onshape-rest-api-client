...
if TYPE_CHECKING:
    ...
    from ..models.btpl_value_249 import BTPLValue249


T = TypeVar("T", bound="BTPStatementAssignment270")


@_attrs_define
class BTPStatementAssignment270:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        lvalue (BTPLValue249 | Unset):
        operator (GBTPOperator | Unset):
        rvalue (BTPExpression9 | Unset):
    """
    ...
    lvalue: BTPLValue249 | Unset = UNSET
    operator: GBTPOperator | Unset = UNSET
    rvalue: BTPExpression9 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        lvalue: dict[str, Any] | Unset = UNSET
        if not isinstance(self.lvalue, Unset):
            lvalue = self.lvalue.to_dict()

        operator: str | Unset = UNSET
        if not isinstance(self.operator, Unset):
            operator = self.operator.value

        rvalue: dict[str, Any] | Unset = UNSET
        if not isinstance(self.rvalue, Unset):
            rvalue = self.rvalue.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _lvalue = d.pop("lvalue", UNSET)
        lvalue: BTPLValue249 | Unset
        if isinstance(_lvalue, Unset):
            lvalue = UNSET
        else:
            lvalue = BTPLValue249.from_dict(_lvalue)
        ...
        _rvalue = d.pop("rvalue", UNSET)
        rvalue: BTPExpression9 | Unset
        if isinstance(_rvalue, Unset):
            rvalue = UNSET
        else:
            rvalue = BTPExpression9.from_dict(_rvalue)

        btp_statement_assignment_270 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_statement_assignment_270.additional_properties = d
        return btp_statement_assignment_270
