...
T = TypeVar("T", bound="BTPStatementContinue274")


@_attrs_define
class BTPStatementContinue274:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        space_after_continue (BTPSpace10 | Unset):
    """
    ...
    space_after_continue: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_continue: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_continue, Unset):
            space_after_continue = self.space_after_continue.to_dict()
        ...
        if space_after_continue is not UNSET:
            field_dict["spaceAfterContinue"] = space_after_continue
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _space_after_continue = d.pop("spaceAfterContinue", UNSET)
        space_after_continue: BTPSpace10 | Unset
        if isinstance(_space_after_continue, Unset):
            space_after_continue = UNSET
        else:
            space_after_continue = BTPSpace10.from_dict(_space_after_continue)

        btp_statement_continue_274 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            space_after_continue=space_after_continue,
        )

        btp_statement_continue_274.additional_properties = d
        return btp_statement_continue_274
