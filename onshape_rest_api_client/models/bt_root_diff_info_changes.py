...
T = TypeVar("T", bound="BTRootDiffInfoChanges")


@_attrs_define
class BTRootDiffInfoChanges:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_root_diff_info_changes.additional_properties = additional_properties
        return bt_root_diff_info_changes
