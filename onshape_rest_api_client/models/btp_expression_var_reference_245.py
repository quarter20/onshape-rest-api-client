...
T = TypeVar("T", bound="BTPExpressionVarReference245")


@_attrs_define
class BTPExpressionVarReference245:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = BTPName261.from_dict(_name)

        btp_expression_var_reference_245 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_expression_var_reference_245.additional_properties = d
        return btp_expression_var_reference_245
