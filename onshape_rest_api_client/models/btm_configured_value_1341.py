...
T = TypeVar("T", bound="BTMConfiguredValue1341")


@_attrs_define
class BTMConfiguredValue1341:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_configured_value_1341.additional_properties = d
        return btm_configured_value_1341
