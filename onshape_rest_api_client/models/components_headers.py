...
T = TypeVar("T", bound="ComponentsHeaders")


@_attrs_define
class ComponentsHeaders:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        components_headers.additional_properties = additional_properties
        return components_headers
