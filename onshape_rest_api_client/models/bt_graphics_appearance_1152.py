...
T = TypeVar("T", bound="BTGraphicsAppearance1152")


@_attrs_define
class BTGraphicsAppearance1152:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_graphics_appearance_1152 = cls(
            bt_type=bt_type,
            color=color,
        ...
        bt_graphics_appearance_1152.additional_properties = d
        return bt_graphics_appearance_1152
