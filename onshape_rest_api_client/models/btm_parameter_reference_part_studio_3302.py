...
T = TypeVar("T", bound="BTMParameterReferencePartStudio3302")


@_attrs_define
class BTMParameterReferencePartStudio3302:
    """
    Attributes:
        block_build_function_access (bool | Unset):
        ...
        part_query (BTMParameterQueryList148 | Unset):
        query_data_key (str | Unset):
        standard_content_parameters_id (str | Unset):
        value_string (str | Unset):
    """

    block_build_function_access: bool | Unset = UNSET
    ...
    part_query: BTMParameterQueryList148 | Unset = UNSET
    query_data_key: str | Unset = UNSET
    standard_content_parameters_id: str | Unset = UNSET
    value_string: str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        block_build_function_access = self.block_build_function_access
        ...
        part_query: dict[str, Any] | Unset = UNSET
        if not isinstance(self.part_query, Unset):
            part_query = self.part_query.to_dict()

        query_data_key = self.query_data_key
        ...
        field_dict.update({})
        if block_build_function_access is not UNSET:
            field_dict["blockBuildFunctionAccess"] = block_build_function_access
        ...
        if query_data_key is not UNSET:
            field_dict["queryDataKey"] = query_data_key
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        block_build_function_access = d.pop("blockBuildFunctionAccess", UNSET)
        ...
        _part_query = d.pop("partQuery", UNSET)
        part_query: BTMParameterQueryList148 | Unset
        if isinstance(_part_query, Unset):
            part_query = UNSET
        else:
            part_query = BTMParameterQueryList148.from_dict(_part_query)

        query_data_key = d.pop("queryDataKey", UNSET)

        standard_content_parameters_id = d.pop("standardContentParametersId", UNSET)

        value_string = d.pop("valueString", UNSET)

        btm_parameter_reference_part_studio_3302 = cls(
            block_build_function_access=block_build_function_access,
            bt_type=bt_type,
            ...
            query_data_key=query_data_key,
            standard_content_parameters_id=standard_content_parameters_id,
            value_string=value_string,
        )

        btm_parameter_reference_part_studio_3302.additional_properties = d
        return btm_parameter_reference_part_studio_3302
