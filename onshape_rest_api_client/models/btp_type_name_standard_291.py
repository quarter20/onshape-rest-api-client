...
T = TypeVar("T", bound="BTPTypeNameStandard291")


@_attrs_define
class BTPTypeNameStandard291:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_type_name_standard_291 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_type_name_standard_291.additional_properties = d
        return btp_type_name_standard_291
