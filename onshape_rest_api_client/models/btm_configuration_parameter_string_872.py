...
T = TypeVar("T", bound="BTMConfigurationParameterString872")


@_attrs_define
class BTMConfigurationParameterString872:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_configuration_parameter_string_872 = cls(
            bt_type=bt_type,
        ...
        btm_configuration_parameter_string_872.additional_properties = d
        return btm_configuration_parameter_string_872
