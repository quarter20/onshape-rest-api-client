...
T = TypeVar("T", bound="GBTDeleteCommentMessageBody")


@_attrs_define
class GBTDeleteCommentMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_delete_comment_message_body = cls(
        ...
        gbt_delete_comment_message_body.additional_properties = d
        return gbt_delete_comment_message_body
