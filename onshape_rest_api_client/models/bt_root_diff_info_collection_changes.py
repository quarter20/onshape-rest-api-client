...
T = TypeVar("T", bound="BTRootDiffInfoCollectionChanges")


@_attrs_define
class BTRootDiffInfoCollectionChanges:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        bt_root_diff_info_collection_changes = cls()
        ...
        bt_root_diff_info_collection_changes.additional_properties = additional_properties
        return bt_root_diff_info_collection_changes
