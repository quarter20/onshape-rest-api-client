...
T = TypeVar("T", bound="BTPointEntity1439")


@_attrs_define
class BTPointEntity1439:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_point_entity_1439.additional_properties = d
        return bt_point_entity_1439
