...
T = TypeVar("T", bound="BTReleaseItemMessageBody")


@_attrs_define
class BTReleaseItemMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_release_item_message_body = cls(
        ...
        bt_release_item_message_body.additional_properties = d
        return bt_release_item_message_body
