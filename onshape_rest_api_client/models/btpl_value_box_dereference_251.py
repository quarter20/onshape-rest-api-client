...
T = TypeVar("T", bound="BTPLValueBoxDereference251")


@_attrs_define
class BTPLValueBoxDereference251:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        box (BTPExpression9 | Unset):
        space_inside (BTPSpace10 | Unset):
    """
    ...
    box: BTPExpression9 | Unset = UNSET
    space_inside: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_inside: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_inside, Unset):
            space_inside = self.space_inside.to_dict()
        ...
        if box is not UNSET:
            field_dict["box"] = box
        if space_inside is not UNSET:
            field_dict["spaceInside"] = space_inside
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_box, Unset):
            ...
            box = BTPExpression9.from_dict(_box)

        _space_inside = d.pop("spaceInside", UNSET)
        space_inside: BTPSpace10 | Unset
        if isinstance(_space_inside, Unset):
            space_inside = UNSET
        else:
            space_inside = BTPSpace10.from_dict(_space_inside)

        btpl_value_box_dereference_251 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            box=box,
            space_inside=space_inside,
        )

        btpl_value_box_dereference_251.additional_properties = d
        return btpl_value_box_dereference_251
