...
T = TypeVar("T", bound="BTCurveGeometryControlPointSpline2197")


@_attrs_define
class BTCurveGeometryControlPointSpline2197:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if is_bezier is not UNSET:
            field_dict["isBezier"] = is_bezier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_bezier = d.pop("isBezier", UNSET)

        bt_curve_geometry_control_point_spline_2197 = cls(
            bt_type=bt_type,
        ...
        bt_curve_geometry_control_point_spline_2197.additional_properties = d
        return bt_curve_geometry_control_point_spline_2197
