...
if TYPE_CHECKING:
    from ..models.bt_spline_description_2118 import BTSplineDescription2118
    from ..models.bt_vector_3d389 import BTVector3D389


T = TypeVar("T", bound="BTSweepDescription1473")


@_attrs_define
class BTSweepDescription1473:
    """
    Attributes:
        ...
        profile (BTSplineDescription2118 | Unset):
    """
    ...
    profile: BTSplineDescription2118 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_profile, Unset):
            ...
            profile = BTSplineDescription2118.from_dict(_profile)

        bt_sweep_description_1473 = cls(
            bt_type=bt_type,
            direction=direction,
        ...
        bt_sweep_description_1473.additional_properties = d
        return bt_sweep_description_1473
