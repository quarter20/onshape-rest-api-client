...
T = TypeVar("T", bound="BTMReadOnlyParameter3800")


@_attrs_define
class BTMReadOnlyParameter3800:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_read_only_parameter_3800 = cls(
            bt_type=bt_type,
        ...
        btm_read_only_parameter_3800.additional_properties = d
        return btm_read_only_parameter_3800
