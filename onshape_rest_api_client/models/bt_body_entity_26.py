...
T = TypeVar("T", bound="BTBodyEntity26")


@_attrs_define
class BTBodyEntity26:
    """
    Attributes:
        ...
        does_not_use_levels_of_detail (bool | Unset):
    """
    ...
    does_not_use_levels_of_detail: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        does_not_use_levels_of_detail = self.does_not_use_levels_of_detail
        ...
        if does_not_use_levels_of_detail is not UNSET:
            field_dict["doesNotUseLevelsOfDetail"] = does_not_use_levels_of_detail
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        does_not_use_levels_of_detail = d.pop("doesNotUseLevelsOfDetail", UNSET)

        bt_body_entity_26 = cls(
            bt_type=bt_type,
            ...
            does_not_use_levels_of_detail=does_not_use_levels_of_detail,
        )

        bt_body_entity_26.additional_properties = d
        return bt_body_entity_26
