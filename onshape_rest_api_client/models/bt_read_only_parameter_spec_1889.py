...
T = TypeVar("T", bound="BTReadOnlyParameterSpec1889")


@_attrs_define
class BTReadOnlyParameterSpec1889:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_read_only_parameter_spec_1889 = cls(
        ...
        bt_read_only_parameter_spec_1889.additional_properties = d
        return bt_read_only_parameter_spec_1889
