...
T = TypeVar("T", bound="BTParameterSpecIcon4779")


@_attrs_define
class BTParameterSpecIcon4779:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if allow_link is not UNSET:
            field_dict["allowLink"] = allow_link
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allow_link = d.pop("allowLink", UNSET)

        bt_parameter_spec_icon_4779 = cls(
        ...
        bt_parameter_spec_icon_4779.additional_properties = d
        return bt_parameter_spec_icon_4779
