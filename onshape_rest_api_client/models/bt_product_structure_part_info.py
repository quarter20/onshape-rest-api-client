...
T = TypeVar("T", bound="BTProductStructurePartInfo")


@_attrs_define
class BTProductStructurePartInfo:
    """
    Attributes:
        json_type (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_product_structure_part_info = cls(
            json_type=json_type,
            href=href,
            id=id,
            name=name,
        ...
        bt_product_structure_part_info.additional_properties = d
        return bt_product_structure_part_info
