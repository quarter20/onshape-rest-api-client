...
from ...models.bt_metadata_object_list_info_bt_metadata_element_info import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/metadata/d/{did}/{wvm}/{wvmid}/e".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    response_default = BTMetadataObjectListInfoBTMetadataElementInfo.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BTMetadataObjectListInfoBTMetadataElementInfo]:
    return Response(
...
def sync_detailed(
    ...
    * You can specify the optional `depth` query parameter to get multiple levels in an assembly.
    Default `depth` is `1`.
...
def sync(
    ...
    *,
    ...
    include_computed_assembly_properties: bool | Unset = False,
    thumbnail: bool | Unset = False,
) -> BTMetadataObjectListInfoBTMetadataElementInfo | None:
    """Get the metadata for all elements in a document.
