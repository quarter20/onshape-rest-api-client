...
if TYPE_CHECKING:
    from ..models.upload_file_create_element_body_file import UploadFileCreateElementBodyFile


T = TypeVar("T", bound="UploadFileCreateElementBody")


@_attrs_define
class UploadFileCreateElementBody:
    """
    Attributes:
        file (UploadFileCreateElementBodyFile | Unset): The file to upload.
    ...
    file: UploadFileCreateElementBodyFile | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file: UploadFileCreateElementBodyFile | Unset
        if isinstance(_file, Unset):
            file = UNSET
        else:
            file = UploadFileCreateElementBodyFile.from_dict(_file)
        ...
        upload_file_create_element_body = cls(
            file=file,
        ...
        upload_file_create_element_body.additional_properties = d
        return upload_file_create_element_body
