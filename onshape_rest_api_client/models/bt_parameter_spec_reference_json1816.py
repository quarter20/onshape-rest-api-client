...
T = TypeVar("T", bound="BTParameterSpecReferenceJSON1816")


@_attrs_define
class BTParameterSpecReferenceJSON1816:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_json1816 = cls(
        ...
        bt_parameter_spec_reference_json1816.additional_properties = d
        return bt_parameter_spec_reference_json1816
