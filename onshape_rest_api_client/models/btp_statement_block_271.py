...
T = TypeVar("T", bound="BTPStatementBlock271")


@_attrs_define
class BTPStatementBlock271:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        space_after_open (BTPSpace10 | Unset):
    """
    ...
    space_after_open: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_open: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_open, Unset):
            space_after_open = self.space_after_open.to_dict()
        ...
        if space_after_open is not UNSET:
            field_dict["spaceAfterOpen"] = space_after_open
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _space_after_open = d.pop("spaceAfterOpen", UNSET)
        space_after_open: BTPSpace10 | Unset
        if isinstance(_space_after_open, Unset):
            space_after_open = UNSET
        else:
            space_after_open = BTPSpace10.from_dict(_space_after_open)

        btp_statement_block_271 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_statement_block_271.additional_properties = d
        return btp_statement_block_271
