...
T = TypeVar("T", bound="BTPStatementExpression275")


@_attrs_define
class BTPStatementExpression275:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_statement_expression_275 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_statement_expression_275.additional_properties = d
        return btp_statement_expression_275
