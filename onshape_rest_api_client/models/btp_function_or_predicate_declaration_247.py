...
T = TypeVar("T", bound="BTPFunctionOrPredicateDeclaration247")


@_attrs_define
class BTPFunctionOrPredicateDeclaration247:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_function_or_predicate_declaration_247 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_function_or_predicate_declaration_247.additional_properties = d
        return btp_function_or_predicate_declaration_247
