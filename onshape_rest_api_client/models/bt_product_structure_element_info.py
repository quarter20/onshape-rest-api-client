...
T = TypeVar("T", bound="BTProductStructureElementInfo")


@_attrs_define
class BTProductStructureElementInfo:
    """
    Attributes:
        json_type (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        children_href = self.children_href
        ...
        if children_href is not UNSET:
            field_dict["childrenHref"] = children_href
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        children_href = d.pop("childrenHref", UNSET)

        bt_product_structure_element_info = cls(
            json_type=json_type,
            href=href,
            id=id,
            name=name,
            ...
            children_href=children_href,
        )

        bt_product_structure_element_info.additional_properties = d
        return bt_product_structure_element_info
