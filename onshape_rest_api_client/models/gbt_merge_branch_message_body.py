...
T = TypeVar("T", bound="GBTMergeBranchMessageBody")


@_attrs_define
class GBTMergeBranchMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_merge_branch_message_body = cls(
        ...
        gbt_merge_branch_message_body.additional_properties = d
        return gbt_merge_branch_message_body
