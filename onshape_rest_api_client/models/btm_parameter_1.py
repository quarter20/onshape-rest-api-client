...
T = TypeVar("T", bound="BTMParameter1")


@_attrs_define
class BTMParameter1:
    """A list of parameter values for instantiation of the feature spec. Parameters are present for all defined parameters,
    even if not used in a specific instantiation.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_1.additional_properties = d
        return btm_parameter_1
