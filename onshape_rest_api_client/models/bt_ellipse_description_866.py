...
T = TypeVar("T", bound="BTEllipseDescription866")


@_attrs_define
class BTEllipseDescription866:
    """
    Attributes:
        ...
        major_axis (BTVector3D389 | Unset):
    ...
    major_axis: BTVector3D389 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        major_axis: dict[str, Any] | Unset = UNSET
        if not isinstance(self.major_axis, Unset):
            major_axis = self.major_axis.to_dict()
        ...
        if major_axis is not UNSET:
            field_dict["majorAxis"] = major_axis
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _major_axis = d.pop("majorAxis", UNSET)
        major_axis: BTVector3D389 | Unset
        if isinstance(_major_axis, Unset):
            major_axis = UNSET
        else:
            major_axis = BTVector3D389.from_dict(_major_axis)
        ...
        bt_ellipse_description_866 = cls(
            bt_type=bt_type,
            direction=direction,
        ...
        bt_ellipse_description_866.additional_properties = d
        return bt_ellipse_description_866
