...
T = TypeVar("T", bound="BTParameterSpecQuantity173")


@_attrs_define
class BTParameterSpecQuantity173:
    """
    Attributes:
        ...
        ranges (list[BTQuantityRange181] | Unset):
    """
    ...
    ranges: list[BTQuantityRange181] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _ranges is not UNSET:
            ...
            for ranges_item_data in _ranges:
                ranges_item = BTQuantityRange181.from_dict(ranges_item_data)

                ranges.append(ranges_item)

        bt_parameter_spec_quantity_173 = cls(
        ...
        bt_parameter_spec_quantity_173.additional_properties = d
        return bt_parameter_spec_quantity_173
