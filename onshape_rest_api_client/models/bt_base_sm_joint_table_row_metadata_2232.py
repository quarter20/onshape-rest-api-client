...
T = TypeVar("T", bound="BTBaseSMJointTableRowMetadata2232")


@_attrs_define
class BTBaseSMJointTableRowMetadata2232:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_base_sm_joint_table_row_metadata_2232 = cls(
            bt_type=bt_type,
            cross_highlight_data_if_any=cross_highlight_data_if_any,
            cross_highlight_data=cross_highlight_data,
        )

        bt_base_sm_joint_table_row_metadata_2232.additional_properties = d
        return bt_base_sm_joint_table_row_metadata_2232
