...
T = TypeVar("T", bound="BTPStatementLoopWhile280")


@_attrs_define
class BTPStatementLoopWhile280:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_statement_loop_while_280 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_statement_loop_while_280.additional_properties = d
        return btp_statement_loop_while_280
