...
T = TypeVar("T", bound="BTMNonGeometricItem1864")


@_attrs_define
class BTMNonGeometricItem1864:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_non_geometric_item_1864 = cls(
            bt_type=bt_type,
        ...
        btm_non_geometric_item_1864.additional_properties = d
        return btm_non_geometric_item_1864
