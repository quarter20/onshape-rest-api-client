...
T = TypeVar("T", bound="BTPStatementConstantDeclaration273")


@_attrs_define
class BTPStatementConstantDeclaration273:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_statement_constant_declaration_273 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_statement_constant_declaration_273.additional_properties = d
        return btp_statement_constant_declaration_273
