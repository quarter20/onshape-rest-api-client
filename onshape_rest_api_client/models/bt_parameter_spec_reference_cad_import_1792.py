...
T = TypeVar("T", bound="BTParameterSpecReferenceCADImport1792")


@_attrs_define
class BTParameterSpecReferenceCADImport1792:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_cad_import_1792 = cls(
        ...
        bt_parameter_spec_reference_cad_import_1792.additional_properties = d
        return bt_parameter_spec_reference_cad_import_1792
