...
T = TypeVar("T", bound="BTParameterSpecMaterial2700")


@_attrs_define
class BTParameterSpecMaterial2700:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_material_2700 = cls(
        ...
        bt_parameter_spec_material_2700.additional_properties = d
        return bt_parameter_spec_material_2700
