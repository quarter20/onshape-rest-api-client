...
T = TypeVar("T", bound="BTMMeshPointQuery1183")


@_attrs_define
class BTMMeshPointQuery1183:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_mesh_point_query_1183.additional_properties = d
        return btm_mesh_point_query_1183
