...
T = TypeVar("T", bound="BTPAnnotation231")


@_attrs_define
class BTPAnnotation231:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    value: BTPLiteralMap256 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_value, Unset):
            ...
            value = BTPLiteralMap256.from_dict(_value)

        btp_annotation_231 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_annotation_231.additional_properties = d
        return btp_annotation_231
