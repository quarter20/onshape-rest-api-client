...
T = TypeVar("T", bound="BTAppElementIdsInfo")


@_attrs_define
class BTAppElementIdsInfo:
    """
    Attributes:
        change_id (str | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        subelement_ids: list[str] | Unset = UNSET
        if not isinstance(self.subelement_ids, Unset):
            subelement_ids = self.subelement_ids
        ...
        if subelement_ids is not UNSET:
            field_dict["subelementIds"] = subelement_ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subelement_ids = cast(list[str], d.pop("subelementIds", UNSET))

        bt_app_element_ids_info = cls(
            change_id=change_id,
        ...
        bt_app_element_ids_info.additional_properties = d
        return bt_app_element_ids_info
