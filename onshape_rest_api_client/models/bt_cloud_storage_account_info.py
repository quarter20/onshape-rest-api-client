...
if TYPE_CHECKING:
    from ..models.bt_cloud_storage_object_info import BTCloudStorageObjectInfo
    from ..models.bt_owner_info import BTOwnerInfo
    from ..models.bt_user_basic_summary_info import BTUserBasicSummaryInfo


T = TypeVar("T", bound="BTCloudStorageAccountInfo")


@_attrs_define
class BTCloudStorageAccountInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
        ...
        enabled (bool | Unset):
        export_folder (BTCloudStorageObjectInfo | Unset):
        import_folder (BTCloudStorageObjectInfo | Unset):
        last_authenticated (datetime.datetime | Unset):
    """
    ...
    export_folder: BTCloudStorageObjectInfo | Unset = UNSET
    import_folder: BTCloudStorageObjectInfo | Unset = UNSET
    last_authenticated: datetime.datetime | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        export_folder: dict[str, Any] | Unset = UNSET
        if not isinstance(self.export_folder, Unset):
            export_folder = self.export_folder.to_dict()

        import_folder: dict[str, Any] | Unset = UNSET
        if not isinstance(self.import_folder, Unset):
            import_folder = self.import_folder.to_dict()

        last_authenticated: str | Unset = UNSET
        if not isinstance(self.last_authenticated, Unset):
            last_authenticated = self.last_authenticated.isoformat()
        ...
        if export_folder is not UNSET:
            field_dict["exportFolder"] = export_folder
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _export_folder = d.pop("exportFolder", UNSET)
        export_folder: BTCloudStorageObjectInfo | Unset
        if isinstance(_export_folder, Unset):
            export_folder = UNSET
        else:
            export_folder = BTCloudStorageObjectInfo.from_dict(_export_folder)

        _import_folder = d.pop("importFolder", UNSET)
        import_folder: BTCloudStorageObjectInfo | Unset
        if isinstance(_import_folder, Unset):
            import_folder = UNSET
        else:
            import_folder = BTCloudStorageObjectInfo.from_dict(_import_folder)

        _last_authenticated = d.pop("lastAuthenticated", UNSET)
        last_authenticated: datetime.datetime | Unset
        ...
        bt_cloud_storage_account_info.additional_properties = d
        return bt_cloud_storage_account_info
