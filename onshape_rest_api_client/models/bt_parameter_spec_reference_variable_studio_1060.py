...
T = TypeVar("T", bound="BTParameterSpecReferenceVariableStudio1060")


@_attrs_define
class BTParameterSpecReferenceVariableStudio1060:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_variable_studio_1060 = cls(
        ...
        bt_parameter_spec_reference_variable_studio_1060.additional_properties = d
        return bt_parameter_spec_reference_variable_studio_1060
