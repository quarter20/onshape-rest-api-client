...
if TYPE_CHECKING:
    ...
    from ..models.btp_literal_map_256 import BTPLiteralMap256
    from ..models.btp_space_10 import BTPSpace10


T = TypeVar("T", bound="BTPExpressionSwitch2632")


@_attrs_define
class BTPExpressionSwitch2632:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        choices (BTPLiteralMap256 | Unset):
        selector (BTPExpression9 | Unset):
        space_after_switch (BTPSpace10 | Unset):
    """
    ...
    choices: BTPLiteralMap256 | Unset = UNSET
    selector: BTPExpression9 | Unset = UNSET
    space_after_switch: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_switch: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_switch, Unset):
            space_after_switch = self.space_after_switch.to_dict()
        ...
        if space_after_switch is not UNSET:
            field_dict["spaceAfterSwitch"] = space_after_switch
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_choices, Unset):
            ...
            choices = BTPLiteralMap256.from_dict(_choices)
        ...
        if isinstance(_selector, Unset):
            ...
            selector = BTPExpression9.from_dict(_selector)

        _space_after_switch = d.pop("spaceAfterSwitch", UNSET)
        space_after_switch: BTPSpace10 | Unset
        if isinstance(_space_after_switch, Unset):
            space_after_switch = UNSET
        else:
            space_after_switch = BTPSpace10.from_dict(_space_after_switch)

        btp_expression_switch_2632 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            choices=choices,
            selector=selector,
            space_after_switch=space_after_switch,
        )

        btp_expression_switch_2632.additional_properties = d
        return btp_expression_switch_2632
