...
T = TypeVar("T", bound="BTLinearDimensionDisplayData330")


@_attrs_define
class BTLinearDimensionDisplayData330:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_linear_dimension_display_data_330 = cls(
            bt_type=bt_type,
        ...
        bt_linear_dimension_display_data_330.additional_properties = d
        return bt_linear_dimension_display_data_330
