...
T = TypeVar("T", bound="BTMParameterDerived864")


@_attrs_define
class BTMParameterDerived864:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_derived_864.additional_properties = d
        return btm_parameter_derived_864
