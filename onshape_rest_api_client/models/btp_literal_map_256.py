...
if TYPE_CHECKING:
    from ..models.btp_literal_map_entry_257 import BTPLiteralMapEntry257
    from ..models.btp_space_10 import BTPSpace10


T = TypeVar("T", bound="BTPLiteralMap256")


@_attrs_define
class BTPLiteralMap256:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        entries (list[BTPLiteralMapEntry257] | Unset):
        node_id (str | Unset):
    ...
    entries: list[BTPLiteralMapEntry257] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _entries is not UNSET:
            ...
            for entries_item_data in _entries:
                entries_item = BTPLiteralMapEntry257.from_dict(entries_item_data)
        ...
        btp_literal_map_256.additional_properties = d
        return btp_literal_map_256
