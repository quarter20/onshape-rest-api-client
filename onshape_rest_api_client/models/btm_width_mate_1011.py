...
if TYPE_CHECKING:
    ...
    from ..models.btm_parameter_query_with_occurrence_list_67 import BTMParameterQueryWithOccurrenceList67
    from ..models.btm_suppression_state_1924 import BTMSuppressionState1924


T = TypeVar("T", bound="BTMWidthMate1011")


@_attrs_define
class BTMWidthMate1011:
    """
    Attributes:
        ...
        version (int | Unset):
        mate_connectors_not_used_in_query (list[BTMMateConnector66] | Unset):
        tab_mate_connector_query_list (BTMParameterQueryWithOccurrenceList67 | Unset):
        width_mate_connector_query_list (BTMParameterQueryWithOccurrenceList67 | Unset):
    """
    ...
    mate_connectors_not_used_in_query: list[BTMMateConnector66] | Unset = UNSET
    tab_mate_connector_query_list: BTMParameterQueryWithOccurrenceList67 | Unset = UNSET
    width_mate_connector_query_list: BTMParameterQueryWithOccurrenceList67 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        mate_connectors_not_used_in_query: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.mate_connectors_not_used_in_query, Unset):
            mate_connectors_not_used_in_query = []
            for mate_connectors_not_used_in_query_item_data in self.mate_connectors_not_used_in_query:
                mate_connectors_not_used_in_query_item = mate_connectors_not_used_in_query_item_data.to_dict()
                mate_connectors_not_used_in_query.append(mate_connectors_not_used_in_query_item)

        tab_mate_connector_query_list: dict[str, Any] | Unset = UNSET
        if not isinstance(self.tab_mate_connector_query_list, Unset):
            tab_mate_connector_query_list = self.tab_mate_connector_query_list.to_dict()

        width_mate_connector_query_list: dict[str, Any] | Unset = UNSET
        if not isinstance(self.width_mate_connector_query_list, Unset):
            width_mate_connector_query_list = self.width_mate_connector_query_list.to_dict()
        ...
        if mate_connectors_not_used_in_query is not UNSET:
            field_dict["mateConnectorsNotUsedInQuery"] = mate_connectors_not_used_in_query
        if tab_mate_connector_query_list is not UNSET:
            field_dict["tabMateConnectorQueryList"] = tab_mate_connector_query_list
        if width_mate_connector_query_list is not UNSET:
            field_dict["widthMateConnectorQueryList"] = width_mate_connector_query_list
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _mate_connectors_not_used_in_query = d.pop("mateConnectorsNotUsedInQuery", UNSET)
        mate_connectors_not_used_in_query: list[BTMMateConnector66] | Unset = UNSET
        if _mate_connectors_not_used_in_query is not UNSET:
            mate_connectors_not_used_in_query = []
            for mate_connectors_not_used_in_query_item_data in _mate_connectors_not_used_in_query:
                mate_connectors_not_used_in_query_item = BTMMateConnector66.from_dict(
                    mate_connectors_not_used_in_query_item_data
                )

                mate_connectors_not_used_in_query.append(mate_connectors_not_used_in_query_item)

        _tab_mate_connector_query_list = d.pop("tabMateConnectorQueryList", UNSET)
        tab_mate_connector_query_list: BTMParameterQueryWithOccurrenceList67 | Unset
        if isinstance(_tab_mate_connector_query_list, Unset):
            tab_mate_connector_query_list = UNSET
        else:
            tab_mate_connector_query_list = BTMParameterQueryWithOccurrenceList67.from_dict(
                _tab_mate_connector_query_list
            )

        _width_mate_connector_query_list = d.pop("widthMateConnectorQueryList", UNSET)
        width_mate_connector_query_list: BTMParameterQueryWithOccurrenceList67 | Unset
        if isinstance(_width_mate_connector_query_list, Unset):
            width_mate_connector_query_list = UNSET
        else:
            width_mate_connector_query_list = BTMParameterQueryWithOccurrenceList67.from_dict(
                _width_mate_connector_query_list
            )

        btm_width_mate_1011 = cls(
            bt_type=bt_type,
            ...
            version=version,
            mate_connectors_not_used_in_query=mate_connectors_not_used_in_query,
            tab_mate_connector_query_list=tab_mate_connector_query_list,
            width_mate_connector_query_list=width_mate_connector_query_list,
        )

        btm_width_mate_1011.additional_properties = d
        return btm_width_mate_1011
