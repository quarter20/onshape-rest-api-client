...
T = TypeVar("T", bound="BTOriginEntity935")


@_attrs_define
class BTOriginEntity935:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_origin_entity_935.additional_properties = d
        return bt_origin_entity_935
