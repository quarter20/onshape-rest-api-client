...
T = TypeVar("T", bound="BTPExpressionIs242")


@_attrs_define
class BTPExpressionIs242:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        operand (BTPExpression9 | Unset):
        type_name (BTPTypeName290 | Unset):
    """
    ...
    operand: BTPExpression9 | Unset = UNSET
    type_name: BTPTypeName290 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_operand, Unset):
            ...
            operand = BTPExpression9.from_dict(_operand)
        ...
        if isinstance(_type_name, Unset):
            ...
            type_name = BTPTypeName290.from_dict(_type_name)

        btp_expression_is_242 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_expression_is_242.additional_properties = d
        return btp_expression_is_242
