...
T = TypeVar("T", bound="BTParameterSpecQuery174")


@_attrs_define
class BTParameterSpecQuery174:
    """
    Attributes:
        ...
        additional_box_select_filter (BTQueryFilter183 | Unset):
        filter_ (BTQueryFilter183 | Unset):
    ...
    additional_box_select_filter: BTQueryFilter183 | Unset = UNSET
    filter_: BTQueryFilter183 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        additional_box_select_filter: dict[str, Any] | Unset = UNSET
        if not isinstance(self.additional_box_select_filter, Unset):
            additional_box_select_filter = self.additional_box_select_filter.to_dict()
        ...
        if additional_box_select_filter is not UNSET:
            field_dict["additionalBoxSelectFilter"] = additional_box_select_filter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _additional_box_select_filter = d.pop("additionalBoxSelectFilter", UNSET)
        additional_box_select_filter: BTQueryFilter183 | Unset
        if isinstance(_additional_box_select_filter, Unset):
            additional_box_select_filter = UNSET
        else:
            additional_box_select_filter = BTQueryFilter183.from_dict(_additional_box_select_filter)
        ...
        if isinstance(_filter_, Unset):
            ...
            filter_ = BTQueryFilter183.from_dict(_filter_)

        max_number_of_picks = d.pop("maxNumberOfPicks", UNSET)

        bt_parameter_spec_query_174 = cls(
            ...
            additional_box_select_filter=additional_box_select_filter,
            filter_=filter_,
            max_number_of_picks=max_number_of_picks,
        )

        bt_parameter_spec_query_174.additional_properties = d
        return bt_parameter_spec_query_174
