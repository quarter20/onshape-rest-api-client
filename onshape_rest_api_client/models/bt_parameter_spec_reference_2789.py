...
T = TypeVar("T", bound="BTParameterSpecReference2789")


@_attrs_define
class BTParameterSpecReference2789:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_2789 = cls(
        ...
        bt_parameter_spec_reference_2789.additional_properties = d
        return bt_parameter_spec_reference_2789
