...
T = TypeVar("T", bound="BTDocumentMessageBody")


@_attrs_define
class BTDocumentMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_document_message_body.additional_properties = d
        return bt_document_message_body
