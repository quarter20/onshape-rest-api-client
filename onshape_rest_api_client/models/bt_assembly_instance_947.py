...
T = TypeVar("T", bound="BTAssemblyInstance947")


@_attrs_define
class BTAssemblyInstance947:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_assembly_instance_947.additional_properties = d
        return bt_assembly_instance_947
