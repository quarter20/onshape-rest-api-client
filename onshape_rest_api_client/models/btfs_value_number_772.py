...
T = TypeVar("T", bound="BTFSValueNumber772")


@_attrs_define
class BTFSValueNumber772:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btfs_value_number_772 = cls(
            bt_type=bt_type,
            type_tag=type_tag,
            value=value,
        )

        btfs_value_number_772.additional_properties = d
        return btfs_value_number_772
