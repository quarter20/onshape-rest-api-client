...
if TYPE_CHECKING:
    from ..models.bt_classroom_info_assignments_with_errors import BTClassroomInfoAssignmentsWithErrors
    from ..models.bt_owner_info import BTOwnerInfo
    from ..models.bt_user_basic_summary_info import BTUserBasicSummaryInfo


T = TypeVar("T", bound="BTClassroomInfo")


@_attrs_define
class BTClassroomInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
        ...
        assignments_with_errors (BTClassroomInfoAssignmentsWithErrors | Unset):
        educator (bool | Unset):
        number_of_assignments (int | Unset):
        number_of_members (int | Unset):
        state (int | Unset):
    ...
    assignments_with_errors: BTClassroomInfoAssignmentsWithErrors | Unset = UNSET
    educator: bool | Unset = UNSET
    number_of_assignments: int | Unset = UNSET
    number_of_members: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        assignments_with_errors: dict[str, Any] | Unset = UNSET
        if not isinstance(self.assignments_with_errors, Unset):
            assignments_with_errors = self.assignments_with_errors.to_dict()

        educator = self.educator

        number_of_assignments = self.number_of_assignments
        ...
        if assignments_with_errors is not UNSET:
            field_dict["assignmentsWithErrors"] = assignments_with_errors
        if educator is not UNSET:
            field_dict["educator"] = educator
        if number_of_assignments is not UNSET:
            field_dict["numberOfAssignments"] = number_of_assignments
        if number_of_members is not UNSET:
            field_dict["numberOfMembers"] = number_of_members
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _assignments_with_errors = d.pop("assignmentsWithErrors", UNSET)
        assignments_with_errors: BTClassroomInfoAssignmentsWithErrors | Unset
        if isinstance(_assignments_with_errors, Unset):
            assignments_with_errors = UNSET
        else:
            assignments_with_errors = BTClassroomInfoAssignmentsWithErrors.from_dict(_assignments_with_errors)

        educator = d.pop("educator", UNSET)

        number_of_assignments = d.pop("numberOfAssignments", UNSET)

        number_of_members = d.pop("numberOfMembers", UNSET)
        ...
        bt_classroom_info.additional_properties = d
        return bt_classroom_info
