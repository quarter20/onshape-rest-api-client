...
T = TypeVar("T", bound="BTMIndividualQueryWithOccurrence811")


@_attrs_define
class BTMIndividualQueryWithOccurrence811:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_individual_query_with_occurrence_811 = cls(
            bt_type=bt_type,
        ...
        btm_individual_query_with_occurrence_811.additional_properties = d
        return btm_individual_query_with_occurrence_811
