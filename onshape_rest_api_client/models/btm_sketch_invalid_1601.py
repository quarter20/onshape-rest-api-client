...
T = TypeVar("T", bound="BTMSketchInvalid1601")


@_attrs_define
class BTMSketchInvalid1601:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_sketch_invalid_1601.additional_properties = d
        return btm_sketch_invalid_1601
