...
if TYPE_CHECKING:
    from ..models.bt_parameter_lookup_table_list_entry_1916 import BTParameterLookupTableListEntry1916
...
T = TypeVar("T", bound="BTParameterSpecLookupTablePath761")


@_attrs_define
class BTParameterSpecLookupTablePath761:
    """
    Attributes:
        ...
        lookup_table (BTParameterLookupTableListEntry1916 | Unset):
    """
    ...
    lookup_table: BTParameterLookupTableListEntry1916 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        lookup_table: dict[str, Any] | Unset = UNSET
        if not isinstance(self.lookup_table, Unset):
        ...
        if lookup_table is not UNSET:
            field_dict["lookupTable"] = lookup_table
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _lookup_table = d.pop("lookupTable", UNSET)
        lookup_table: BTParameterLookupTableListEntry1916 | Unset
        if isinstance(_lookup_table, Unset):
            lookup_table = UNSET
        else:
            lookup_table = BTParameterLookupTableListEntry1916.from_dict(_lookup_table)

        bt_parameter_spec_lookup_table_path_761 = cls(
        ...
        bt_parameter_spec_lookup_table_path_761.additional_properties = d
        return bt_parameter_spec_lookup_table_path_761
