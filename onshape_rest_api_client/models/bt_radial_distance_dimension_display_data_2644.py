...
T = TypeVar("T", bound="BTRadialDistanceDimensionDisplayData2644")


@_attrs_define
class BTRadialDistanceDimensionDisplayData2644:
    """
    Attributes:
        ...
        value (float | Unset):
        inner_witness_end_point_0_angle (float | Unset):
        inner_witness_end_point_1_angle (float | Unset):
        inner_witness_radius (float | Unset):
        outer_witness_end_point_0_angle (float | Unset):
        outer_witness_end_point_1_angle (float | Unset):
        outer_witness_radius (float | Unset):
        position_angle (float | Unset):
        position_radius (float | Unset):
    """
    ...
    inner_witness_end_point_0_angle: float | Unset = UNSET
    inner_witness_end_point_1_angle: float | Unset = UNSET
    inner_witness_radius: float | Unset = UNSET
    outer_witness_end_point_0_angle: float | Unset = UNSET
    outer_witness_end_point_1_angle: float | Unset = UNSET
    outer_witness_radius: float | Unset = UNSET
    position_angle: float | Unset = UNSET
    position_radius: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        inner_witness_end_point_0_angle = self.inner_witness_end_point_0_angle

        inner_witness_end_point_1_angle = self.inner_witness_end_point_1_angle

        inner_witness_radius = self.inner_witness_radius

        outer_witness_end_point_0_angle = self.outer_witness_end_point_0_angle

        outer_witness_end_point_1_angle = self.outer_witness_end_point_1_angle

        outer_witness_radius = self.outer_witness_radius
        ...
        if inner_witness_end_point_0_angle is not UNSET:
            field_dict["innerWitnessEndPoint0Angle"] = inner_witness_end_point_0_angle
        if inner_witness_end_point_1_angle is not UNSET:
            field_dict["innerWitnessEndPoint1Angle"] = inner_witness_end_point_1_angle
        if inner_witness_radius is not UNSET:
            field_dict["innerWitnessRadius"] = inner_witness_radius
        if outer_witness_end_point_0_angle is not UNSET:
            field_dict["outerWitnessEndPoint0Angle"] = outer_witness_end_point_0_angle
        if outer_witness_end_point_1_angle is not UNSET:
            field_dict["outerWitnessEndPoint1Angle"] = outer_witness_end_point_1_angle
        if outer_witness_radius is not UNSET:
            field_dict["outerWitnessRadius"] = outer_witness_radius
        if position_angle is not UNSET:
            field_dict["positionAngle"] = position_angle
        if position_radius is not UNSET:
            field_dict["positionRadius"] = position_radius
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inner_witness_end_point_0_angle = d.pop("innerWitnessEndPoint0Angle", UNSET)

        inner_witness_end_point_1_angle = d.pop("innerWitnessEndPoint1Angle", UNSET)

        inner_witness_radius = d.pop("innerWitnessRadius", UNSET)

        outer_witness_end_point_0_angle = d.pop("outerWitnessEndPoint0Angle", UNSET)

        outer_witness_end_point_1_angle = d.pop("outerWitnessEndPoint1Angle", UNSET)

        outer_witness_radius = d.pop("outerWitnessRadius", UNSET)

        position_angle = d.pop("positionAngle", UNSET)

        position_radius = d.pop("positionRadius", UNSET)

        bt_radial_distance_dimension_display_data_2644 = cls(
            bt_type=bt_type,
            ...
            value=value,
            inner_witness_end_point_0_angle=inner_witness_end_point_0_angle,
            inner_witness_end_point_1_angle=inner_witness_end_point_1_angle,
            inner_witness_radius=inner_witness_radius,
            outer_witness_end_point_0_angle=outer_witness_end_point_0_angle,
            outer_witness_end_point_1_angle=outer_witness_end_point_1_angle,
            outer_witness_radius=outer_witness_radius,
            position_angle=position_angle,
            position_radius=position_radius,
        )

        bt_radial_distance_dimension_display_data_2644.additional_properties = d
        return bt_radial_distance_dimension_display_data_2644
