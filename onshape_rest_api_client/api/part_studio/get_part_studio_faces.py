...
from ...models.get_part_studio_faces_wvm import GetPartStudioFacesWvm
from ...types import UNSET, Response, Unset


def _get_kwargs(
    did: str,
    wvm: GetPartStudioFacesWvm,
    wvmid: str,
    eid: str,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/partstudios/d/{did}/{wvm}/{wvmid}/e/{eid}/tessellatedfaces".format(
