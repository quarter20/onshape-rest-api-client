...
T = TypeVar("T", bound="BTFullElementId756")


@_attrs_define
class BTFullElementId756:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_full_element_id_756.additional_properties = d
        return bt_full_element_id_756
