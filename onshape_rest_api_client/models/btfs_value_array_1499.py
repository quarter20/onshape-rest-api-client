...
T = TypeVar("T", bound="BTFSValueArray1499")


@_attrs_define
class BTFSValueArray1499:
    """
    Attributes:
        bt_type (str): Type of JSON object.
        type_tag (str | Unset):
        value (list[BTFSValue1888] | Unset):
    """

    bt_type: str
    type_tag: str | Unset = UNSET
    value: list[BTFSValue1888] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = BTFSValue1888.from_dict(value_item_data)

                value.append(value_item)

        btfs_value_array_1499 = cls(
            bt_type=bt_type,
            type_tag=type_tag,
            value=value,
        )

        btfs_value_array_1499.additional_properties = d
        return btfs_value_array_1499
