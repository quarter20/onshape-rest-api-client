...
T = TypeVar("T", bound="BTParameterSpecReferenceTable1520")


@_attrs_define
class BTParameterSpecReferenceTable1520:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_table_1520 = cls(
        ...
        bt_parameter_spec_reference_table_1520.additional_properties = d
        return bt_parameter_spec_reference_table_1520
