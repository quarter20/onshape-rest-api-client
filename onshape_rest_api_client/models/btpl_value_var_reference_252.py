...
T = TypeVar("T", bound="BTPLValueVarReference252")


@_attrs_define
class BTPLValueVarReference252:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btpl_value_var_reference_252 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btpl_value_var_reference_252.additional_properties = d
        return btpl_value_var_reference_252
