...
T = TypeVar("T", bound="BTInstanceBase2263")


@_attrs_define
class BTInstanceBase2263:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_instance_base_2263.additional_properties = d
        return bt_instance_base_2263
