...
if TYPE_CHECKING:
    ...
    from ..models.btm_rigid_feature_3076_suppressed_in_simulations import BTMRigidFeature3076SuppressedInSimulations
    from ..models.btm_suppression_state_1924 import BTMSuppressionState1924


T = TypeVar("T", bound="BTMRigidFeature3076")


@_attrs_define
class BTMRigidFeature3076:
    """
    Attributes:
        ...
        suppressed_in_simulations (BTMRigidFeature3076SuppressedInSimulations | Unset):
    """
    ...
    suppressed_in_simulations: BTMRigidFeature3076SuppressedInSimulations | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_suppressed_in_simulations, Unset):
            ...
            suppressed_in_simulations = BTMRigidFeature3076SuppressedInSimulations.from_dict(_suppressed_in_simulations)

        btm_rigid_feature_3076 = cls(
            bt_type=bt_type,
        ...
        btm_rigid_feature_3076.additional_properties = d
        return btm_rigid_feature_3076
