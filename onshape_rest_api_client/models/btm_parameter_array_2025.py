...
if TYPE_CHECKING:
    from ..models.btm_array_parameter_item_1843 import BTMArrayParameterItem1843


T = TypeVar("T", bound="BTMParameterArray2025")


@_attrs_define
class BTMParameterArray2025:
    """
    Attributes:
        ...
        items (list[BTMArrayParameterItem1843] | Unset):
    """
    ...
    items: list[BTMArrayParameterItem1843] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = BTMArrayParameterItem1843.from_dict(items_item_data)

                items.append(items_item)

        btm_parameter_array_2025 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_array_2025.additional_properties = d
        return btm_parameter_array_2025
