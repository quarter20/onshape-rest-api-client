...
T = TypeVar("T", bound="GBTCreateVersionMessageBody")


@_attrs_define
class GBTCreateVersionMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_create_version_message_body = cls(
        ...
        gbt_create_version_message_body.additional_properties = d
        return gbt_create_version_message_body
