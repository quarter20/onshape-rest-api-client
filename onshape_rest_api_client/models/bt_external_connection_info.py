...
T = TypeVar("T", bound="BTExternalConnectionInfo")


@_attrs_define
class BTExternalConnectionInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
        ...
        approved_by (BTUserSummaryInfo | Unset):
        icon (str | Unset):
        invited_company (BTCompanySummaryInfo | Unset):
        is_owner_enterprise_edu (bool | Unset):
        member (bool | Unset):
    ...
    approved_by: BTUserSummaryInfo | Unset = UNSET
    icon: str | Unset = UNSET
    invited_company: BTCompanySummaryInfo | Unset = UNSET
    is_owner_enterprise_edu: bool | Unset = UNSET
    member: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        invited_company: dict[str, Any] | Unset = UNSET
        if not isinstance(self.invited_company, Unset):
            invited_company = self.invited_company.to_dict()

        is_owner_enterprise_edu = self.is_owner_enterprise_edu
        ...
        if invited_company is not UNSET:
            field_dict["invitedCompany"] = invited_company
        if is_owner_enterprise_edu is not UNSET:
            field_dict["isOwnerEnterpriseEdu"] = is_owner_enterprise_edu
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_approved_by, Unset):
            ...
            approved_by = BTUserSummaryInfo.from_dict(_approved_by)

        icon = d.pop("icon", UNSET)

        _invited_company = d.pop("invitedCompany", UNSET)
        invited_company: BTCompanySummaryInfo | Unset
        if isinstance(_invited_company, Unset):
            invited_company = UNSET
        else:
            invited_company = BTCompanySummaryInfo.from_dict(_invited_company)

        is_owner_enterprise_edu = d.pop("isOwnerEnterpriseEdu", UNSET)
        ...
        bt_external_connection_info = cls(
            json_type=json_type,
            can_move=can_move,
            ...
            is_owner_enterprise_edu=is_owner_enterprise_edu,
            member=member,
        ...
        bt_external_connection_info.additional_properties = d
        return bt_external_connection_info
