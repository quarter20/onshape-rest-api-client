...
T = TypeVar("T", bound="BTMParameterQuantity147")


@_attrs_define
class BTMParameterQuantity147:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_quantity_147 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_quantity_147.additional_properties = d
        return btm_parameter_quantity_147
