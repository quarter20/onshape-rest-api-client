...
T = TypeVar("T", bound="BTPTopLevelTypeDeclaration287")


@_attrs_define
class BTPTopLevelTypeDeclaration287:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_top_level_type_declaration_287 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_top_level_type_declaration_287.additional_properties = d
        return btp_top_level_type_declaration_287
