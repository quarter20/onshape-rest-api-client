...
T = TypeVar("T", bound="BTParameterVisibilityAlwaysShown5487")


@_attrs_define
class BTParameterVisibilityAlwaysShown5487:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_visibility_always_shown_5487 = cls(
            bt_type=bt_type,
            self_or_child_always_visible=self_or_child_always_visible,
        )

        bt_parameter_visibility_always_shown_5487.additional_properties = d
        return bt_parameter_visibility_always_shown_5487
