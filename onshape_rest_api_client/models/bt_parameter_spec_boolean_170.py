...
T = TypeVar("T", bound="BTParameterSpecBoolean170")


@_attrs_define
class BTParameterSpecBoolean170:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_boolean_170 = cls(
        ...
        bt_parameter_spec_boolean_170.additional_properties = d
        return bt_parameter_spec_boolean_170
