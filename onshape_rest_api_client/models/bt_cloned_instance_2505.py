...
T = TypeVar("T", bound="BTClonedInstance2505")


@_attrs_define
class BTClonedInstance2505:
    """
    Attributes:
        ...
        version (int | Unset):
        seed_occurrence (BTOccurrence74 | Unset):
    """
    ...
    seed_occurrence: BTOccurrence74 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        seed_occurrence: dict[str, Any] | Unset = UNSET
        if not isinstance(self.seed_occurrence, Unset):
            seed_occurrence = self.seed_occurrence.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _seed_occurrence = d.pop("seedOccurrence", UNSET)
        seed_occurrence: BTOccurrence74 | Unset
        if isinstance(_seed_occurrence, Unset):
            seed_occurrence = UNSET
        else:
            seed_occurrence = BTOccurrence74.from_dict(_seed_occurrence)

        bt_cloned_instance_2505 = cls(
            bt_type=bt_type,
        ...
        bt_cloned_instance_2505.additional_properties = d
        return bt_cloned_instance_2505
