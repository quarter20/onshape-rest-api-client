...
T = TypeVar("T", bound="BTMParameterAppearance627")


@_attrs_define
class BTMParameterAppearance627:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_appearance_627 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_appearance_627.additional_properties = d
        return btm_parameter_appearance_627
