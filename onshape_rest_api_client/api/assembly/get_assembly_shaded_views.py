...
from ...models.get_assembly_shaded_views_wvm import GetAssemblyShadedViewsWvm
from ...types import UNSET, Response, Unset


def _get_kwargs(
    did: str,
    wvm: GetAssemblyShadedViewsWvm,
    wvmid: str,
    eid: str,
    *,
    ...
    include_surfaces: bool | Unset = True,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/assemblies/d/{did}/{wvm}/{wvmid}/e/{eid}/shadedviews".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        include_surfaces (bool | Unset):  Default: True.
