...
T = TypeVar("T", bound="BTParametricPartStudioChildInstance3696")


@_attrs_define
class BTParametricPartStudioChildInstance3696:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parametric_part_studio_child_instance_3696 = cls(
            bt_type=bt_type,
        ...
        bt_parametric_part_studio_child_instance_3696.additional_properties = d
        return bt_parametric_part_studio_child_instance_3696
