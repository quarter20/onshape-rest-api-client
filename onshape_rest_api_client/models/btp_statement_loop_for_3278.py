...
T = TypeVar("T", bound="BTPStatementLoopFor3278")


@_attrs_define
class BTPStatementLoopFor3278:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        increment (BTPStatement269 | Unset):
        initialization (BTPStatement269 | Unset):
        space_after_initialization (BTPSpace10 | Unset):
        space_before_condition (BTPSpace10 | Unset):
        space_before_increment (BTPSpace10 | Unset):
    """
    ...
    increment: BTPStatement269 | Unset = UNSET
    initialization: BTPStatement269 | Unset = UNSET
    space_after_initialization: BTPSpace10 | Unset = UNSET
    space_before_condition: BTPSpace10 | Unset = UNSET
    space_before_increment: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_initialization: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_initialization, Unset):
            space_after_initialization = self.space_after_initialization.to_dict()

        space_before_condition: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_before_condition, Unset):
            space_before_condition = self.space_before_condition.to_dict()

        space_before_increment: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_before_increment, Unset):
            space_before_increment = self.space_before_increment.to_dict()
        ...
        if space_after_initialization is not UNSET:
            field_dict["spaceAfterInitialization"] = space_after_initialization
        if space_before_condition is not UNSET:
            field_dict["spaceBeforeCondition"] = space_before_condition
        if space_before_increment is not UNSET:
            field_dict["spaceBeforeIncrement"] = space_before_increment
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_increment, Unset):
            ...
            increment = BTPStatement269.from_dict(_increment)
        ...
        if isinstance(_initialization, Unset):
            ...
            initialization = BTPStatement269.from_dict(_initialization)

        _space_after_initialization = d.pop("spaceAfterInitialization", UNSET)
        space_after_initialization: BTPSpace10 | Unset
        if isinstance(_space_after_initialization, Unset):
            space_after_initialization = UNSET
        else:
            space_after_initialization = BTPSpace10.from_dict(_space_after_initialization)

        _space_before_condition = d.pop("spaceBeforeCondition", UNSET)
        space_before_condition: BTPSpace10 | Unset
        if isinstance(_space_before_condition, Unset):
            space_before_condition = UNSET
        else:
            space_before_condition = BTPSpace10.from_dict(_space_before_condition)

        _space_before_increment = d.pop("spaceBeforeIncrement", UNSET)
        space_before_increment: BTPSpace10 | Unset
        if isinstance(_space_before_increment, Unset):
            space_before_increment = UNSET
        else:
            space_before_increment = BTPSpace10.from_dict(_space_before_increment)

        btp_statement_loop_for_3278 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            space_after_initialization=space_after_initialization,
            space_before_condition=space_before_condition,
            space_before_increment=space_before_increment,
        )

        btp_statement_loop_for_3278.additional_properties = d
        return btp_statement_loop_for_3278
