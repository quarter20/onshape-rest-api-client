...
T = TypeVar("T", bound="BTMFeatureInvalid1031")


@_attrs_define
class BTMFeatureInvalid1031:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_feature_invalid_1031.additional_properties = d
        return btm_feature_invalid_1031
