...
if TYPE_CHECKING:
    from ..models.bt_annotation_g_tol_row_display_data_4397 import BTAnnotationGTolRowDisplayData4397
    from ..models.bt_coordinate_system_387 import BTCoordinateSystem387
    from ..models.bt_vector_2d1812 import BTVector2D1812


T = TypeVar("T", bound="BTAnnotationGTolDisplayData4887")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _rows is not UNSET:
            ...
            for rows_item_data in _rows:
                rows_item = BTAnnotationGTolRowDisplayData4397.from_dict(rows_item_data)
        ...
        bt_annotation_g_tol_display_data_4887.additional_properties = d
        return bt_annotation_g_tol_display_data_4887
