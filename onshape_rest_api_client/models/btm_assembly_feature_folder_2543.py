...
T = TypeVar("T", bound="BTMAssemblyFeatureFolder2543")


@_attrs_define
class BTMAssemblyFeatureFolder2543:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_assembly_feature_folder_2543 = cls(
            bt_type=bt_type,
        ...
        btm_assembly_feature_folder_2543.additional_properties = d
        return btm_assembly_feature_folder_2543
