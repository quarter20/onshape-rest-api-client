...
T = TypeVar("T", bound="BTPTopLevelEnumDeclaration284")


@_attrs_define
class BTPTopLevelEnumDeclaration284:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        annotations (list[BTPAnnotation231] | Unset):
        space_in_empty_list (BTPSpace10 | Unset):
        trailing_comma (bool | Unset):
        values (list[BTPIdentifier8] | Unset):
    """
    ...
    annotations: list[BTPAnnotation231] | Unset = UNSET
    space_in_empty_list: BTPSpace10 | Unset = UNSET
    trailing_comma: bool | Unset = UNSET
    values: list[BTPIdentifier8] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if trailing_comma is not UNSET:
            field_dict["trailingComma"] = trailing_comma
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _annotations is not UNSET:
            ...
            for annotations_item_data in _annotations:
                annotations_item = BTPAnnotation231.from_dict(annotations_item_data)
        ...
        trailing_comma = d.pop("trailingComma", UNSET)
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = BTPIdentifier8.from_dict(values_item_data)

                values.append(values_item)

        btp_top_level_enum_declaration_284 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_top_level_enum_declaration_284.additional_properties = d
        return btp_top_level_enum_declaration_284
