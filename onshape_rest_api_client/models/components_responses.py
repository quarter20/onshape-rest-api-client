...
T = TypeVar("T", bound="ComponentsResponses")
...
class ComponentsResponses:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        components_responses.additional_properties = additional_properties
        return components_responses
