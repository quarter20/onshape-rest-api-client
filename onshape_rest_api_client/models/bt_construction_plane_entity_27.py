...
T = TypeVar("T", bound="BTConstructionPlaneEntity27")


@_attrs_define
class BTConstructionPlaneEntity27:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_construction_plane_entity_27 = cls(
            bt_type=bt_type,
        ...
        bt_construction_plane_entity_27.additional_properties = d
        return bt_construction_plane_entity_27
