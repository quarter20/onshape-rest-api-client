...
T = TypeVar("T", bound="GBTBranchWorkspaceMessageBody")


@_attrs_define
class GBTBranchWorkspaceMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_branch_workspace_message_body = cls(
        ...
        gbt_branch_workspace_message_body.additional_properties = d
        return gbt_branch_workspace_message_body
