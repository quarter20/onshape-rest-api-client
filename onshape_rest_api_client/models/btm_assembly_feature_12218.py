...
T = TypeVar("T", bound="BTMAssemblyFeature12218")


@_attrs_define
class BTMAssemblyFeature12218:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_assembly_feature_12218 = cls(
            bt_type=bt_type,
        ...
        btm_assembly_feature_12218.additional_properties = d
        return btm_assembly_feature_12218
