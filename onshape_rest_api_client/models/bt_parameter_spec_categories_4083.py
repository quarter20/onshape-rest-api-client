...
if TYPE_CHECKING:
    from ..models.bt_parameter_spec_categories_4083_category_id_to_metadata_types import (
        BTParameterSpecCategories4083CategoryIdToMetadataTypes,
    )
    from ..models.bt_parameter_spec_multi_enum_3118_enum_value_to_visibility_condition import (
...
T = TypeVar("T", bound="BTParameterSpecCategories4083")


@_attrs_define
class BTParameterSpecCategories4083:
    """
    Attributes:
        ...
        enum_name (str | Unset):
        enum_value_to_visibility_condition (BTParameterSpecMultiEnum3118EnumValueToVisibilityCondition | Unset):
        multivalued (bool | Unset):
        namespace (str | Unset):
        option_names (list[str] | Unset):
        options (list[str] | Unset):
        category_id_to_metadata_types (BTParameterSpecCategories4083CategoryIdToMetadataTypes | Unset):
    """
    ...
    enum_value_to_visibility_condition: BTParameterSpecMultiEnum3118EnumValueToVisibilityCondition | Unset = UNSET
    multivalued: bool | Unset = UNSET
    namespace: str | Unset = UNSET
    option_names: list[str] | Unset = UNSET
    options: list[str] | Unset = UNSET
    category_id_to_metadata_types: BTParameterSpecCategories4083CategoryIdToMetadataTypes | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        category_id_to_metadata_types: dict[str, Any] | Unset = UNSET
        if not isinstance(self.category_id_to_metadata_types, Unset):
            category_id_to_metadata_types = self.category_id_to_metadata_types.to_dict()
        ...
        if category_id_to_metadata_types is not UNSET:
            field_dict["categoryIdToMetadataTypes"] = category_id_to_metadata_types
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_enum_value_to_visibility_condition, Unset):
            ...
            enum_value_to_visibility_condition = BTParameterSpecMultiEnum3118EnumValueToVisibilityCondition.from_dict(
        ...
        _category_id_to_metadata_types = d.pop("categoryIdToMetadataTypes", UNSET)
        category_id_to_metadata_types: BTParameterSpecCategories4083CategoryIdToMetadataTypes | Unset
        if isinstance(_category_id_to_metadata_types, Unset):
            category_id_to_metadata_types = UNSET
        else:
            category_id_to_metadata_types = BTParameterSpecCategories4083CategoryIdToMetadataTypes.from_dict(
                _category_id_to_metadata_types
            )

        bt_parameter_spec_categories_4083 = cls(
            ...
            options=options,
            category_id_to_metadata_types=category_id_to_metadata_types,
        )

        bt_parameter_spec_categories_4083.additional_properties = d
        return bt_parameter_spec_categories_4083
