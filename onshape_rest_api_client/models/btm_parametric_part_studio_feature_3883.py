...
T = TypeVar("T", bound="BTMParametricPartStudioFeature3883")


@_attrs_define
class BTMParametricPartStudioFeature3883:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parametric_part_studio_feature_3883 = cls(
        ...
        btm_parametric_part_studio_feature_3883.additional_properties = d
        return btm_parametric_part_studio_feature_3883
