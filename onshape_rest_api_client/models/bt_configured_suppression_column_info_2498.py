...
T = TypeVar("T", bound="BTConfiguredSuppressionColumnInfo2498")


@_attrs_define
class BTConfiguredSuppressionColumnInfo2498:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_configured_suppression_column_info_2498 = cls(
            bt_type=bt_type,
            id=id,
            node_id=node_id,
        ...
        bt_configured_suppression_column_info_2498.additional_properties = d
        return bt_configured_suppression_column_info_2498
