...
T = TypeVar("T", bound="BTPExpressionNew243")


@_attrs_define
class BTPExpressionNew243:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        space_after_box (BTPSpace10 | Unset):
        space_between_new_box (BTPSpace10 | Unset):
    ...
    space_after_box: BTPSpace10 | Unset = UNSET
    space_between_new_box: BTPSpace10 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        space_after_box: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_after_box, Unset):
            space_after_box = self.space_after_box.to_dict()

        space_between_new_box: dict[str, Any] | Unset = UNSET
        if not isinstance(self.space_between_new_box, Unset):
            space_between_new_box = self.space_between_new_box.to_dict()
        ...
        if space_after_box is not UNSET:
            field_dict["spaceAfterBox"] = space_after_box
        if space_between_new_box is not UNSET:
            field_dict["spaceBetweenNewBox"] = space_between_new_box
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _space_after_box = d.pop("spaceAfterBox", UNSET)
        space_after_box: BTPSpace10 | Unset
        if isinstance(_space_after_box, Unset):
            space_after_box = UNSET
        else:
            space_after_box = BTPSpace10.from_dict(_space_after_box)

        _space_between_new_box = d.pop("spaceBetweenNewBox", UNSET)
        space_between_new_box: BTPSpace10 | Unset
        if isinstance(_space_between_new_box, Unset):
            space_between_new_box = UNSET
        else:
            space_between_new_box = BTPSpace10.from_dict(_space_between_new_box)
        ...
        btp_expression_new_243 = cls(
            ...
            space_after_box=space_after_box,
            space_between_new_box=space_between_new_box,
            value=value,
        )

        btp_expression_new_243.additional_properties = d
        return btp_expression_new_243
