...
T = TypeVar("T", bound="BTPLiteralNumber258")


@_attrs_define
class BTPLiteralNumber258:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_literal_number_258.additional_properties = d
        return btp_literal_number_258
