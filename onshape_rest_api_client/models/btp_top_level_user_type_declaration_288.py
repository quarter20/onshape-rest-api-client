...
T = TypeVar("T", bound="BTPTopLevelUserTypeDeclaration288")


@_attrs_define
class BTPTopLevelUserTypeDeclaration288:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    typecheck: BTPName261 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        typecheck: dict[str, Any] | Unset = UNSET
        if not isinstance(self.typecheck, Unset):
        ...
        if typecheck is not UNSET:
            field_dict["typecheck"] = typecheck
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _typecheck = d.pop("typecheck", UNSET)
        typecheck: BTPName261 | Unset
        if isinstance(_typecheck, Unset):
            typecheck = UNSET
        else:
            typecheck = BTPName261.from_dict(_typecheck)

        btp_top_level_user_type_declaration_288 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_top_level_user_type_declaration_288.additional_properties = d
        return btp_top_level_user_type_declaration_288
