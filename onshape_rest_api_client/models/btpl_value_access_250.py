...
T = TypeVar("T", bound="BTPLValueAccess250")


@_attrs_define
class BTPLValueAccess250:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_base, Unset):
            ...
            base = BTPLValue249.from_dict(_base)

        btpl_value_access_250 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btpl_value_access_250.additional_properties = d
        return btpl_value_access_250
