...
T = TypeVar("T", bound="BTSpunDescription657")


@_attrs_define
class BTSpunDescription657:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_spun_description_657.additional_properties = d
        return bt_spun_description_657
