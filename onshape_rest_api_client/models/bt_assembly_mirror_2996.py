...
if TYPE_CHECKING:
    ...
    from ..models.btm_assembly_mirror_feature_3037 import BTMAssemblyMirrorFeature3037
    from ..models.btm_suppression_state_1924 import BTMSuppressionState1924


T = TypeVar("T", bound="BTAssemblyMirror2996")


@_attrs_define
class BTAssemblyMirror2996:
    """
    Attributes:
        ...
        mirror_feature (BTMAssemblyMirrorFeature3037 | Unset):
    ...
    mirror_feature: BTMAssemblyMirrorFeature3037 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_mirror_feature, Unset):
            ...
            mirror_feature = BTMAssemblyMirrorFeature3037.from_dict(_mirror_feature)
        ...
        bt_assembly_mirror_2996.additional_properties = d
        return bt_assembly_mirror_2996
