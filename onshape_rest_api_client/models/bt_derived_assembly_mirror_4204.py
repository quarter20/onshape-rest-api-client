...
if TYPE_CHECKING:
    from ..models.bt_assembly_mirror_feature_interface import BTAssemblyMirrorFeatureInterface
    ...
    from ..models.bt_instance_control_node_750 import BTInstanceControlNode750
    from ..models.bt_instance_with_reference import BTInstanceWithReference
    ...
    from ..models.btm_derived_assembly_mirror_feature_5094 import BTMDerivedAssemblyMirrorFeature5094
...
T = TypeVar("T", bound="BTDerivedAssemblyMirror4204")


@_attrs_define
class BTDerivedAssemblyMirror4204:
    """
    Attributes:
        ...
        instance_control_nodes (list[BTInstanceControlNode750] | Unset):
        seed_based_parametric_instance (bool | Unset):
        assembly_reference_parameter (BTMParameterReferenceWithConfiguration3028 | Unset):
        ...
        mirror_feature (BTMDerivedAssemblyMirrorFeature5094 | Unset):
        mirror_feature_interface (BTAssemblyMirrorFeatureInterface | Unset):
    ...
    instance_control_nodes: list[BTInstanceControlNode750] | Unset = UNSET
    seed_based_parametric_instance: bool | Unset = UNSET
    assembly_reference_parameter: BTMParameterReferenceWithConfiguration3028 | Unset = UNSET
    ...
    mirror_feature: BTMDerivedAssemblyMirrorFeature5094 | Unset = UNSET
    mirror_feature_interface: BTAssemblyMirrorFeatureInterface | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        instance_control_nodes: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.instance_control_nodes, Unset):
            instance_control_nodes = []
            for instance_control_nodes_item_data in self.instance_control_nodes:
                instance_control_nodes_item = instance_control_nodes_item_data.to_dict()
                instance_control_nodes.append(instance_control_nodes_item)

        seed_based_parametric_instance = self.seed_based_parametric_instance

        assembly_reference_parameter: dict[str, Any] | Unset = UNSET
        if not isinstance(self.assembly_reference_parameter, Unset):
            assembly_reference_parameter = self.assembly_reference_parameter.to_dict()
        ...
        mirror_feature: dict[str, Any] | Unset = UNSET
        if not isinstance(self.mirror_feature, Unset):
            mirror_feature = self.mirror_feature.to_dict()

        mirror_feature_interface: dict[str, Any] | Unset = UNSET
        if not isinstance(self.mirror_feature_interface, Unset):
            mirror_feature_interface = self.mirror_feature_interface.to_dict()
        ...
        if instance_control_nodes is not UNSET:
            field_dict["instanceControlNodes"] = instance_control_nodes
        if seed_based_parametric_instance is not UNSET:
            field_dict["seedBasedParametricInstance"] = seed_based_parametric_instance
        if assembly_reference_parameter is not UNSET:
            field_dict["assemblyReferenceParameter"] = assembly_reference_parameter
        ...
        if mirror_feature is not UNSET:
            field_dict["mirrorFeature"] = mirror_feature
        if mirror_feature_interface is not UNSET:
            field_dict["mirrorFeatureInterface"] = mirror_feature_interface
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _instance_control_nodes = d.pop("instanceControlNodes", UNSET)
        instance_control_nodes: list[BTInstanceControlNode750] | Unset = UNSET
        if _instance_control_nodes is not UNSET:
            instance_control_nodes = []
            for instance_control_nodes_item_data in _instance_control_nodes:
                instance_control_nodes_item = BTInstanceControlNode750.from_dict(instance_control_nodes_item_data)

                instance_control_nodes.append(instance_control_nodes_item)

        seed_based_parametric_instance = d.pop("seedBasedParametricInstance", UNSET)

        _assembly_reference_parameter = d.pop("assemblyReferenceParameter", UNSET)
        assembly_reference_parameter: BTMParameterReferenceWithConfiguration3028 | Unset
        if isinstance(_assembly_reference_parameter, Unset):
            assembly_reference_parameter = UNSET
        else:
            assembly_reference_parameter = BTMParameterReferenceWithConfiguration3028.from_dict(
                _assembly_reference_parameter
            )
        ...
        _mirror_feature = d.pop("mirrorFeature", UNSET)
        mirror_feature: BTMDerivedAssemblyMirrorFeature5094 | Unset
        if isinstance(_mirror_feature, Unset):
            mirror_feature = UNSET
        else:
            mirror_feature = BTMDerivedAssemblyMirrorFeature5094.from_dict(_mirror_feature)

        _mirror_feature_interface = d.pop("mirrorFeatureInterface", UNSET)
        mirror_feature_interface: BTAssemblyMirrorFeatureInterface | Unset
        if isinstance(_mirror_feature_interface, Unset):
            mirror_feature_interface = UNSET
        else:
            mirror_feature_interface = BTAssemblyMirrorFeatureInterface.from_dict(_mirror_feature_interface)
        ...
        bt_derived_assembly_mirror_4204 = cls(
            bt_type=bt_type,
            ...
            instance_control_nodes=instance_control_nodes,
            seed_based_parametric_instance=seed_based_parametric_instance,
            assembly_reference_parameter=assembly_reference_parameter,
            ...
            mirror_feature_interface=mirror_feature_interface,
        ...
        bt_derived_assembly_mirror_4204.additional_properties = d
        return bt_derived_assembly_mirror_4204
