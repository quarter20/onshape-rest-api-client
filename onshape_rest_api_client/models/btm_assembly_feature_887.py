...
T = TypeVar("T", bound="BTMAssemblyFeature887")


@_attrs_define
class BTMAssemblyFeature887:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_assembly_feature_887.additional_properties = d
        return btm_assembly_feature_887
