...
T = TypeVar("T", bound="BTSubAssemblyInfo")


@_attrs_define
class BTSubAssemblyInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_sub_assembly_info.additional_properties = d
        return bt_sub_assembly_info
