...
T = TypeVar("T", bound="BTPIdentifier8")


@_attrs_define
class BTPIdentifier8:
    """
    Attributes:
        atomic (bool | Unset):
        ...
        invalid_identifier_for_test (str | Unset):
    """
    ...
    invalid_identifier_for_test: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        invalid_identifier_for_test = self.invalid_identifier_for_test
        ...
        if invalid_identifier_for_test is not UNSET:
            field_dict["invalidIdentifierForTest"] = invalid_identifier_for_test
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invalid_identifier_for_test = d.pop("invalidIdentifierForTest", UNSET)

        btp_identifier_8 = cls(
            atomic=atomic,
            bt_type=bt_type,
            ...
            invalid_identifier_for_test=invalid_identifier_for_test,
        )

        btp_identifier_8.additional_properties = d
        return btp_identifier_8
