...
if TYPE_CHECKING:
    from ..models.btm_units_default_160_units import BTMUnitsDefault160Units


T = TypeVar("T", bound="BTMUnitsDefault160")


@_attrs_define
class BTMUnitsDefault160:
    """
    Attributes:
        bt_type (str | Unset): Type of JSON object.
        import_microversion (str | Unset): Microversion that resulted from the import.
        node_id (str | Unset):
        units (BTMUnitsDefault160Units | Unset):
    """

    bt_type: str | Unset = UNSET
    import_microversion: str | Unset = UNSET
    node_id: str | Unset = UNSET
    units: BTMUnitsDefault160Units | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_units, Unset):
            ...
            units = BTMUnitsDefault160Units.from_dict(_units)

        btm_units_default_160 = cls(
            bt_type=bt_type,
        ...
        btm_units_default_160.additional_properties = d
        return btm_units_default_160
