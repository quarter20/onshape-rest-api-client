...
T = TypeVar("T", bound="BTCurveLengthDimensionDisplayData322")


@_attrs_define
class BTCurveLengthDimensionDisplayData322:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_curve_length_dimension_display_data_322 = cls(
            bt_type=bt_type,
        ...
        bt_curve_length_dimension_display_data_322.additional_properties = d
        return bt_curve_length_dimension_display_data_322
