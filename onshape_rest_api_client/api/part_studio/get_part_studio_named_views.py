...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/partstudios/d/{did}/e/{eid}/namedViews".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a list of all named views that exist in the Part Studio.
     ...
     Returns a map from view name to view data for the given element. See the [Part Studios API
    Guide](https://onshape-public.github.io/docs/api-adv/partstudios/) for details and tutorials.
