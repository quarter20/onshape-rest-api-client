...
T = TypeVar("T", bound="BTParameterSpecNotice3132")


@_attrs_define
class BTParameterSpecNotice3132:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_notice_3132 = cls(
        ...
        bt_parameter_spec_notice_3132.additional_properties = d
        return bt_parameter_spec_notice_3132
