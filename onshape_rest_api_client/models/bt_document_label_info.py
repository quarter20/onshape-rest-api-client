...
T = TypeVar("T", bound="BTDocumentLabelInfo")


@_attrs_define
class BTDocumentLabelInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
    ...
    parent_label_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if parent_label_id is not UNSET:
            field_dict["parentLabelId"] = parent_label_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent_label_id = d.pop("parentLabelId", UNSET)

        path = d.pop("path", UNSET)

        bt_document_label_info = cls(
            json_type=json_type,
            can_move=can_move,
        ...
        bt_document_label_info.additional_properties = d
        return bt_document_label_info
