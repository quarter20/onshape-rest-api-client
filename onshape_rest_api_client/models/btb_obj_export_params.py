...
T = TypeVar("T", bound="BTBObjExportParams")


@_attrs_define
class BTBObjExportParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btb_obj_export_params.additional_properties = d
        return btb_obj_export_params
