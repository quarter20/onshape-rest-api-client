...
T = TypeVar("T", bound="BTFSTableColumnInfo623")


@_attrs_define
class BTFSTableColumnInfo623:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btfs_table_column_info_623 = cls(
            bt_type=bt_type,
            id=id,
            node_id=node_id,
        ...
        btfs_table_column_info_623.additional_properties = d
        return btfs_table_column_info_623
