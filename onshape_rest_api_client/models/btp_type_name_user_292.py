...
T = TypeVar("T", bound="BTPTypeNameUser292")


@_attrs_define
class BTPTypeNameUser292:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = BTPName261.from_dict(_type_)

        btp_type_name_user_292 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_type_name_user_292.additional_properties = d
        return btp_type_name_user_292
