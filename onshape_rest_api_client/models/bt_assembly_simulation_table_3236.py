...
T = TypeVar("T", bound="BTAssemblySimulationTable3236")


@_attrs_define
class BTAssemblySimulationTable3236:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_assembly_simulation_table_3236 = cls(
        ...
        bt_assembly_simulation_table_3236.additional_properties = d
        return bt_assembly_simulation_table_3236
