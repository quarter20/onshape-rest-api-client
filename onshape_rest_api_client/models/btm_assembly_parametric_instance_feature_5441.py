...
T = TypeVar("T", bound="BTMAssemblyParametricInstanceFeature5441")


@_attrs_define
class BTMAssemblyParametricInstanceFeature5441:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_assembly_parametric_instance_feature_5441 = cls(
            bt_type=bt_type,
        ...
        btm_assembly_parametric_instance_feature_5441.additional_properties = d
        return btm_assembly_parametric_instance_feature_5441
