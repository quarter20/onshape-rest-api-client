...
T = TypeVar("T", bound="GBTRestoreDocumentFromHistoryMessageBody")


@_attrs_define
class GBTRestoreDocumentFromHistoryMessageBody:
    """
    Attributes:
        app_element_session_id (str | Unset):
        data (str | Unset):
        document_id (str | Unset):
        document_microversion_id (str | Unset):
        event (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_restore_document_from_history_message_body = cls(
        ...
        gbt_restore_document_from_history_message_body.additional_properties = d
        return gbt_restore_document_from_history_message_body
