...
T = TypeVar("T", bound="BTCylinderDescription686")


@_attrs_define
class BTCylinderDescription686:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_cylinder_description_686 = cls(
            bt_type=bt_type,
            direction=direction,
        ...
        bt_cylinder_description_686.additional_properties = d
        return bt_cylinder_description_686
