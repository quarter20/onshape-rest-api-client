...
T = TypeVar("T", bound="BTParameterSpecReferenceBlob1367")


@_attrs_define
class BTParameterSpecReferenceBlob1367:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_blob_1367 = cls(
        ...
        bt_parameter_spec_reference_blob_1367.additional_properties = d
        return bt_parameter_spec_reference_blob_1367
