...
T = TypeVar("T", bound="BTTableTestCellDouble2509")


@_attrs_define
class BTTableTestCellDouble2509:
    """
    Attributes:
        bt_type (str | Unset): Type of JSON object.
        is_ever_visible (bool | Unset):
        is_read_only (bool | Unset):
        cell_value (float | Unset):
    """

    bt_type: str | Unset = UNSET
    is_ever_visible: bool | Unset = UNSET
    is_read_only: bool | Unset = UNSET
    cell_value: float | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_table_test_cell_double_2509 = cls(
            bt_type=bt_type,
        ...
        bt_table_test_cell_double_2509.additional_properties = d
        return bt_table_test_cell_double_2509
