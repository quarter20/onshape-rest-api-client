...
T = TypeVar("T", bound="BTInspectionTableCrossHighlightData4177")


@_attrs_define
class BTInspectionTableCrossHighlightData4177:
    """
    Attributes:
        bt_type (str | Unset): Type of JSON object.
        deterministic_id_list (list[str] | Unset):
        feature_id_list (list[str] | Unset):
        annotation_id_list (list[str] | Unset):
    """

    bt_type: str | Unset = UNSET
    deterministic_id_list: list[str] | Unset = UNSET
    feature_id_list: list[str] | Unset = UNSET
    annotation_id_list: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        annotation_id_list: list[str] | Unset = UNSET
        if not isinstance(self.annotation_id_list, Unset):
            annotation_id_list = self.annotation_id_list
        ...
        if annotation_id_list is not UNSET:
            field_dict["annotationIdList"] = annotation_id_list
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_id_list = cast(list[str], d.pop("annotationIdList", UNSET))

        bt_inspection_table_cross_highlight_data_4177 = cls(
            bt_type=bt_type,
            deterministic_id_list=deterministic_id_list,
            feature_id_list=feature_id_list,
            annotation_id_list=annotation_id_list,
        )

        bt_inspection_table_cross_highlight_data_4177.additional_properties = d
        return bt_inspection_table_cross_highlight_data_4177
