...
T = TypeVar("T", bound="BTEntityDeletion24")


@_attrs_define
class BTEntityDeletion24:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_entity_deletion_24.additional_properties = d
        return bt_entity_deletion_24
