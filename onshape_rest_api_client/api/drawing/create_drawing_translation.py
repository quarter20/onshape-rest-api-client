...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/drawings/d/{did}/{wv}/{wvid}/e/{eid}/translations".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Translate (export) a drawing to a different format.
     ...
     Export a drawing to a different format within a document. Use `getDrawingTranslatorFormats` for a
    list of supported translation (i.e., import/export) formats. See [API Guide:
    Translations](https://onshape-public.github.io/docs/api-adv/translation/#export-a-drawing-as-a-json)
