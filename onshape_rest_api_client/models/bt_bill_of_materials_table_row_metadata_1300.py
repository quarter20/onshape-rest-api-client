...
T = TypeVar("T", bound="BTBillOfMaterialsTableRowMetadata1300")


@_attrs_define
class BTBillOfMaterialsTableRowMetadata1300:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_bill_of_materials_table_row_metadata_1300 = cls(
            bt_type=bt_type,
            cross_highlight_data_if_any=cross_highlight_data_if_any,
            cross_highlight_data=cross_highlight_data,
        )

        bt_bill_of_materials_table_row_metadata_1300.additional_properties = d
        return bt_bill_of_materials_table_row_metadata_1300
