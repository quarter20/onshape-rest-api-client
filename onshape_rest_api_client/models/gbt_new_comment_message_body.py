...
T = TypeVar("T", bound="GBTNewCommentMessageBody")


@_attrs_define
class GBTNewCommentMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_new_comment_message_body = cls(
        ...
        gbt_new_comment_message_body.additional_properties = d
        return gbt_new_comment_message_body
