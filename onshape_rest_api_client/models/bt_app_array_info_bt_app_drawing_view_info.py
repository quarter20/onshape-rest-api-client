...
if TYPE_CHECKING:
    from ..models.bt_app_drawing_view_info import BTAppDrawingViewInfo


T = TypeVar("T", bound="BTAppArrayInfoBTAppDrawingViewInfo")


@_attrs_define
class BTAppArrayInfoBTAppDrawingViewInfo:
    """
    Attributes:
        change_id (str | Unset):
        ...
        items (list[BTAppDrawingViewInfo] | Unset):
    ...
    items: list[BTAppDrawingViewInfo] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _items is not UNSET:
            ...
            for items_item_data in _items:
                items_item = BTAppDrawingViewInfo.from_dict(items_item_data)

                items.append(items_item)

        parent_change_id = d.pop("parentChangeId", UNSET)

        bt_app_array_info_bt_app_drawing_view_info = cls(
            change_id=change_id,
        ...
        bt_app_array_info_bt_app_drawing_view_info.additional_properties = d
        return bt_app_array_info_bt_app_drawing_view_info
