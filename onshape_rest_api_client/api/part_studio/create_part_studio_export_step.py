...
from ...models.btb_step_export_params import BTBStepExportParams
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/partstudios/d/{did}/{wv}/{wvid}/e/{eid}/export/step".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Asynchronously export a Part Studio to STEP.
     ...
     Creates an asynchronous export of a Part Studio to STEP. See [API Guide: Asynchronous
    ...
    Args:
        ...
        wvid (str):
        eid (str):
        body (BTBStepExportParams): Options for exporting elements to STEP.
