...
T = TypeVar("T", bound="BTDocumentProcessingInfo")


@_attrs_define
class BTDocumentProcessingInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if duplicate_name_violation_error is not UNSET:
            field_dict["duplicateNameViolationError"] = duplicate_name_violation_error
        if is_upgraded_to_latest_version is not UNSET:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        duplicate_name_violation_error = d.pop("duplicateNameViolationError", UNSET)
        ...
        bt_document_processing_info = cls(
            json_type=json_type,
            can_move=can_move,
        ...
        bt_document_processing_info.additional_properties = d
        return bt_document_processing_info
