...
T = TypeVar("T", bound="BTMIndividualQueryWithOccurrenceBase904")


@_attrs_define
class BTMIndividualQueryWithOccurrenceBase904:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_individual_query_with_occurrence_base_904 = cls(
            bt_type=bt_type,
        ...
        btm_individual_query_with_occurrence_base_904.additional_properties = d
        return btm_individual_query_with_occurrence_base_904
