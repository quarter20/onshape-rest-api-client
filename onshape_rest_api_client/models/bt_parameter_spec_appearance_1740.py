...
T = TypeVar("T", bound="BTParameterSpecAppearance1740")


@_attrs_define
class BTParameterSpecAppearance1740:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_appearance_1740 = cls(
        ...
        bt_parameter_spec_appearance_1740.additional_properties = d
        return bt_parameter_spec_appearance_1740
