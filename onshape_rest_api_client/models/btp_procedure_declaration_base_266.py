...
T = TypeVar("T", bound="BTPProcedureDeclarationBase266")


@_attrs_define
class BTPProcedureDeclarationBase266:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_procedure_declaration_base_266 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_procedure_declaration_base_266.additional_properties = d
        return btp_procedure_declaration_base_266
