...
T = TypeVar("T", bound="BTParameterSpecReferenceImage1722")


@_attrs_define
class BTParameterSpecReferenceImage1722:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_image_1722 = cls(
        ...
        bt_parameter_spec_reference_image_1722.additional_properties = d
        return bt_parameter_spec_reference_image_1722
