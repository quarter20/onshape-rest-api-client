...
T = TypeVar("T", bound="BTPLiteralUndefined260")


@_attrs_define
class BTPLiteralUndefined260:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_literal_undefined_260.additional_properties = d
        return btp_literal_undefined_260
