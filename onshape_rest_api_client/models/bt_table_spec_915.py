...
T = TypeVar("T", bound="BTTableSpec915")


@_attrs_define
class BTTableSpec915:
    """
    Attributes:
        ...
        computed_property_category_ids (list[str] | Unset):
        default_part_category_id (str | Unset):
        is_computed_property_table (bool | Unset):
    """
    ...
    computed_property_category_ids: list[str] | Unset = UNSET
    default_part_category_id: str | Unset = UNSET
    is_computed_property_table: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        computed_property_category_ids: list[str] | Unset = UNSET
        if not isinstance(self.computed_property_category_ids, Unset):
            computed_property_category_ids = self.computed_property_category_ids

        default_part_category_id = self.default_part_category_id

        is_computed_property_table = self.is_computed_property_table
        ...
        if computed_property_category_ids is not UNSET:
            field_dict["computedPropertyCategoryIds"] = computed_property_category_ids
        if default_part_category_id is not UNSET:
            field_dict["defaultPartCategoryId"] = default_part_category_id
        if is_computed_property_table is not UNSET:
            field_dict["isComputedPropertyTable"] = is_computed_property_table
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        computed_property_category_ids = cast(list[str], d.pop("computedPropertyCategoryIds", UNSET))

        default_part_category_id = d.pop("defaultPartCategoryId", UNSET)

        is_computed_property_table = d.pop("isComputedPropertyTable", UNSET)

        bt_table_spec_915 = cls(
            ...
            computed_property_category_ids=computed_property_category_ids,
            default_part_category_id=default_part_category_id,
            is_computed_property_table=is_computed_property_table,
        )

        bt_table_spec_915.additional_properties = d
        return bt_table_spec_915
