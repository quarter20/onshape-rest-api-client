...
if TYPE_CHECKING:
    from ..models.bt_nullable_quantity_range_1340 import BTNullableQuantityRange1340
...
T = TypeVar("T", bound="BTParameterSpecNullableQuantity715")


@_attrs_define
class BTParameterSpecNullableQuantity715:
    """
    Attributes:
        ...
        ranges (list[BTNullableQuantityRange1340] | Unset):
    """
    ...
    ranges: list[BTNullableQuantityRange1340] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _ranges is not UNSET:
            ...
            for ranges_item_data in _ranges:
                ranges_item = BTNullableQuantityRange1340.from_dict(ranges_item_data)

                ranges.append(ranges_item)

        bt_parameter_spec_nullable_quantity_715 = cls(
        ...
        bt_parameter_spec_nullable_quantity_715.additional_properties = d
        return bt_parameter_spec_nullable_quantity_715
