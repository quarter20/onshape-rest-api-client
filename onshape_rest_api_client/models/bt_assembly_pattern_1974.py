...
if TYPE_CHECKING:
    ...
    from ..models.btm_assembly_pattern_feature_2241 import BTMAssemblyPatternFeature2241
    from ..models.btm_suppression_state_1924 import BTMSuppressionState1924


T = TypeVar("T", bound="BTAssemblyPattern1974")


@_attrs_define
class BTAssemblyPattern1974:
    """
    Attributes:
        ...
        pattern_feature (BTMAssemblyPatternFeature2241 | Unset):
    """
    ...
    pattern_feature: BTMAssemblyPatternFeature2241 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        pattern_feature: dict[str, Any] | Unset = UNSET
        if not isinstance(self.pattern_feature, Unset):
            pattern_feature = self.pattern_feature.to_dict()
        ...
        if pattern_feature is not UNSET:
            field_dict["patternFeature"] = pattern_feature
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _pattern_feature = d.pop("patternFeature", UNSET)
        pattern_feature: BTMAssemblyPatternFeature2241 | Unset
        if isinstance(_pattern_feature, Unset):
            pattern_feature = UNSET
        else:
            pattern_feature = BTMAssemblyPatternFeature2241.from_dict(_pattern_feature)

        bt_assembly_pattern_1974 = cls(
            bt_type=bt_type,
        ...
        bt_assembly_pattern_1974.additional_properties = d
        return bt_assembly_pattern_1974
