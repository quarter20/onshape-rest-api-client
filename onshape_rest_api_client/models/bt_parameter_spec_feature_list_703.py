...
T = TypeVar("T", bound="BTParameterSpecFeatureList703")


@_attrs_define
class BTParameterSpecFeatureList703:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_feature_list_703 = cls(
        ...
        bt_parameter_spec_feature_list_703.additional_properties = d
        return bt_parameter_spec_feature_list_703
