...
T = TypeVar("T", bound="BTPPropertyAccessor23")


@_attrs_define
class BTPPropertyAccessor23:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_property_accessor_23.additional_properties = d
        return btp_property_accessor_23
