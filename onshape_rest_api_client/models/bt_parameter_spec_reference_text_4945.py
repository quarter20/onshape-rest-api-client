...
T = TypeVar("T", bound="BTParameterSpecReferenceText4945")


@_attrs_define
class BTParameterSpecReferenceText4945:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bt_parameter_spec_reference_text_4945 = cls(
        ...
        bt_parameter_spec_reference_text_4945.additional_properties = d
        return bt_parameter_spec_reference_text_4945
