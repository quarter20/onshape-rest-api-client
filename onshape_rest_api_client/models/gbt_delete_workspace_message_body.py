...
T = TypeVar("T", bound="GBTDeleteWorkspaceMessageBody")


@_attrs_define
class GBTDeleteWorkspaceMessageBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gbt_delete_workspace_message_body = cls(
        ...
        gbt_delete_workspace_message_body.additional_properties = d
        return gbt_delete_workspace_message_body
