...
T = TypeVar("T", bound="BTMIndividualCreatedByQuery137")


@_attrs_define
class BTMIndividualCreatedByQuery137:
    """
    Attributes:
        ...
        entity_type (GBTEntityType | Unset):
        feature_id (str | Unset):
        filter_construction (bool | Unset):
    """
    ...
    entity_type: GBTEntityType | Unset = UNSET
    feature_id: str | Unset = UNSET
    filter_construction: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        filter_construction = self.filter_construction
        ...
        if filter_construction is not UNSET:
            field_dict["filterConstruction"] = filter_construction
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_entity_type, Unset):
            ...
            entity_type = GBTEntityType(_entity_type)

        feature_id = d.pop("featureId", UNSET)

        filter_construction = d.pop("filterConstruction", UNSET)

        btm_individual_created_by_query_137 = cls(
            bt_type=bt_type,
        ...
        btm_individual_created_by_query_137.additional_properties = d
        return btm_individual_created_by_query_137
