...
T = TypeVar("T", bound="BTMAssemblyMirrorFeature3037")


@_attrs_define
class BTMAssemblyMirrorFeature3037:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_assembly_mirror_feature_3037 = cls(
        ...
        btm_assembly_mirror_feature_3037.additional_properties = d
        return btm_assembly_mirror_feature_3037
