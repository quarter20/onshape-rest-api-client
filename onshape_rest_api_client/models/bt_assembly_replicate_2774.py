...
if TYPE_CHECKING:
    ...
    from ..models.btm_assembly_replicate_feature_1351 import BTMAssemblyReplicateFeature1351
    from ..models.btm_suppression_state_1924 import BTMSuppressionState1924


T = TypeVar("T", bound="BTAssemblyReplicate2774")


@_attrs_define
class BTAssemblyReplicate2774:
    """
    Attributes:
        ...
        replicate_feature (BTMAssemblyReplicateFeature1351 | Unset):
    """
    ...
    replicate_feature: BTMAssemblyReplicateFeature1351 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        replicate_feature: dict[str, Any] | Unset = UNSET
        if not isinstance(self.replicate_feature, Unset):
            replicate_feature = self.replicate_feature.to_dict()
        ...
        if replicate_feature is not UNSET:
            field_dict["replicateFeature"] = replicate_feature
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _replicate_feature = d.pop("replicateFeature", UNSET)
        replicate_feature: BTMAssemblyReplicateFeature1351 | Unset
        if isinstance(_replicate_feature, Unset):
            replicate_feature = UNSET
        else:
            replicate_feature = BTMAssemblyReplicateFeature1351.from_dict(_replicate_feature)

        bt_assembly_replicate_2774 = cls(
            bt_type=bt_type,
            ...
            replicate_feature=replicate_feature,
        )

        bt_assembly_replicate_2774.additional_properties = d
        return bt_assembly_replicate_2774
