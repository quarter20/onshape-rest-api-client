...
T = TypeVar("T", bound="BTMParameterReferenceJSON790")


@_attrs_define
class BTMParameterReferenceJSON790:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_reference_json790 = cls(
            bt_type=bt_type,
        ...
        btm_parameter_reference_json790.additional_properties = d
        return btm_parameter_reference_json790
