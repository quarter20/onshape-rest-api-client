...
T = TypeVar("T", bound="BTPPredicateDeclaration265")


@_attrs_define
class BTPPredicateDeclaration265:
    """
    Attributes:
        atomic (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btp_predicate_declaration_265 = cls(
            atomic=atomic,
            bt_type=bt_type,
        ...
        btp_predicate_declaration_265.additional_properties = d
        return btp_predicate_declaration_265
