...
T = TypeVar("T", bound="BTMParameterButton5169")


@_attrs_define
class BTMParameterButton5169:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        btm_parameter_button_5169.additional_properties = d
        return btm_parameter_button_5169
