...
T = TypeVar("T", bound="MediaTypeExamples")


@_attrs_define
class MediaTypeExamples:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        media_type_examples.additional_properties = additional_properties
        return media_type_examples
