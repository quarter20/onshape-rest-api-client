...
A heavyweight python client library for accessing the [Onshape REST API](https://onshape-public.github.io/docs/api-intro/explorer/).
...
```python
ONSHAPE_BASE_URL = "https://cad.onshape.com/api/v16"
```
...
```python
from onshape_rest_api_client.models import MyDataModel
from onshape_rest_api_client.api.my_tag import get_my_data_model
from onshape_rest_api_client.types import Response
...
This project's code is 100% auto-generated.  See [MAINTENANCE.md](https://github.com/quarter20/onshape-rest-api-client/blob/main/MAINTENANCE.md) for details.
