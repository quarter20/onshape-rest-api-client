...
T = TypeVar("T", bound="BTMIndividualSketchRegionQuery140")


@_attrs_define
class BTMIndividualSketchRegionQuery140:
    """
    Attributes:
    ...
    filter_inner_loops: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        filter_inner_loops = self.filter_inner_loops
        ...
        if filter_inner_loops is not UNSET:
            field_dict["filterInnerLoops"] = filter_inner_loops
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_inner_loops = d.pop("filterInnerLoops", UNSET)

        btm_individual_sketch_region_query_140 = cls(
            bt_type=bt_type,
            ...
            filter_inner_loops=filter_inner_loops,
        )

        btm_individual_sketch_region_query_140.additional_properties = d
        return btm_individual_sketch_region_query_140
