...
if TYPE_CHECKING:
    ...
    from ..models.bt_string_format_condition_683 import BTStringFormatCondition683
    from ..models.btm_parameter_1 import BTMParameter1


T = TypeVar("T", bound="BTParameterSpecString175")


@_attrs_define
class BTParameterSpecString175:
    """
    Attributes:
        ...
        disallows_empty_strings (str | Unset):
        disallows_html (str | Unset):
        format_conditions (list[BTStringFormatCondition683] | Unset):
    """
    ...
    disallows_empty_strings: str | Unset = UNSET
    disallows_html: str | Unset = UNSET
    format_conditions: list[BTStringFormatCondition683] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        disallows_empty_strings = self.disallows_empty_strings

        disallows_html = self.disallows_html

        format_conditions: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.format_conditions, Unset):
            format_conditions = []
            for format_conditions_item_data in self.format_conditions:
                format_conditions_item = format_conditions_item_data.to_dict()
                format_conditions.append(format_conditions_item)
        ...
        if disallows_empty_strings is not UNSET:
            field_dict["disallowsEmptyStrings"] = disallows_empty_strings
        if disallows_html is not UNSET:
            field_dict["disallowsHtml"] = disallows_html
        if format_conditions is not UNSET:
            field_dict["formatConditions"] = format_conditions
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        disallows_empty_strings = d.pop("disallowsEmptyStrings", UNSET)

        disallows_html = d.pop("disallowsHtml", UNSET)

        _format_conditions = d.pop("formatConditions", UNSET)
        format_conditions: list[BTStringFormatCondition683] | Unset = UNSET
        if _format_conditions is not UNSET:
            format_conditions = []
            for format_conditions_item_data in _format_conditions:
                format_conditions_item = BTStringFormatCondition683.from_dict(format_conditions_item_data)

                format_conditions.append(format_conditions_item)

        bt_parameter_spec_string_175 = cls(
            ...
            disallows_empty_strings=disallows_empty_strings,
            disallows_html=disallows_html,
            format_conditions=format_conditions,
        )

        bt_parameter_spec_string_175.additional_properties = d
        return bt_parameter_spec_string_175
