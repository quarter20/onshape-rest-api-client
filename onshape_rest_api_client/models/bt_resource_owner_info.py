...
T = TypeVar("T", bound="BTResourceOwnerInfo")


@_attrs_define
class BTResourceOwnerInfo:
    """
    Attributes:
        json_type (str):
        can_move (bool | Unset):
    ...
    is_enterprise_edu: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_enterprise_edu = self.is_enterprise_edu
        ...
        if is_enterprise_edu is not UNSET:
            field_dict["isEnterpriseEdu"] = is_enterprise_edu
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        is_enterprise_edu = d.pop("isEnterpriseEdu", UNSET)

        state = d.pop("state", UNSET)

        bt_resource_owner_info = cls(
            json_type=json_type,
            can_move=can_move,
            ...
            view_ref=view_ref,
            icon=icon,
            is_enterprise_edu=is_enterprise_edu,
            state=state,
        )

        bt_resource_owner_info.additional_properties = d
        return bt_resource_owner_info
